    ...
    <div className="h-full w-full flex flex-col bg-[var(--bg-base)]">
      ...
      <div className="flex-1 min-h-0 flex items-center justify-center px-6">
        <div className="flex flex-col items-center gap-4 text-center max-w-md">
          <div className="size-12 rounded-full bg-[var(--bg-elevated)] border border-[var(--border)] flex items-center justify-center">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 h-7 rounded border border-[var(--border)] bg-[var(--bg-secondary)] hover:bg-[var(--bg-hover)] text-[11px] text-[var(--text-secondary)] hover:text-[var(--text-primary)] cursor-pointer transition-colors"
          >
            <FolderOpen size={12} />
            Open in Finder
          </button>
