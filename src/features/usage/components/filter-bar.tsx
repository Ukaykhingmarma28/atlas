...
export function FilterBar({
  ...
  return (
    <div className="flex h-[36px] shrink-0 items-center gap-1.5 border-b border-[var(--atlas-border-subtle)] px-3">
      {AXES.map((a) => (
        <FacetPill
          key={a.axis}
          axis={a.axis}
      ...
      <span className="ml-1 text-2xs uppercase tracking-wider text-[var(--muted-foreground)]">
        Metric
      </span>
