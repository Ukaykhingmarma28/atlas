  ...
  return (
    <>
      <textarea
        ...
        className="min-w-0 flex-1 resize-none overflow-hidden border-none bg-transparent p-0 text-base leading-[18px] text-[var(--text-primary)] outline-none placeholder:text-[var(--text-tertiary)] placeholder:[white-space:nowrap]"
        style={{
