...
const ITEM_BYTES_METRIC: &str = "atlas_agent.rollout.persistence.item_bytes";
const APPEND_METRIC: &str = "atlas_agent.rollout.persistence.append";
const TURN_BYTES_METRIC: &str = "atlas_agent.rollout.persistence.turn_bytes";
const MEASUREMENT_ERROR_METRIC: &str = "atlas_agent.rollout.persistence.measurement_error";
...
impl RolloutPersistenceTelemetry {
    pub fn new(thread_id: ThreadId) -> Self {
        let metrics = atlas_engine_otel::global();
