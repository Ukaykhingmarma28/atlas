...
// It allows the test binary to behave like atlas-agent and dispatch to apply_patch and atlas-engine-linux-sandbox
// based on the arg0.
// NOTE: this doesn't work on ARM
#[ctor]
pub static ATLAS_AGENT_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("atlas-engine-core-tests", |exe_name, argv1| {
        if argv1 == Some(ATLAS_AGENT_CORE_APPLY_PATCH_ARG1) {
