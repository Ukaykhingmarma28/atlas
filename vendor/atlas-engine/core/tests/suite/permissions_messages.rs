...
use atlas_engine_core::context::ApprovalPromptContext;
use atlas_engine_core::context::ContextualUserFragment;
use atlas_engine_core::context::PermissionsInstructions;
use atlas_engine_core::load_exec_policy;
...
) -> atlas_engine_protocol::openai_models::ModelInfo {
