...
async fn emits_warning_when_unstable_features_enabled_via_config() {
    ...
    let user_config_path =
        AbsolutePathBuf::from_absolute_path(config.atlas_agent_home.join(CONFIG_TOML_FILE))
    ...
    let thread_manager = atlas_engine_core::test_support::thread_manager_with_models_provider(
