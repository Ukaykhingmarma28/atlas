...
use atlas_engine_protocol::approvals::ElicitationAction;
...
const CALENDAR_NAMESPACE: &str = "mcp__atlas_apps__calendar";
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "turn_id": turn_id,
                "model_slug": "gpt-5.4",
                "product_client_id": atlas_engine_login::default_client::originator().value,
            }
        })
    );
