...
use atlas_engine_core::spawn::ATLAS_AGENT_SANDBOX_ENV_VAR;
...
use atlas_engine_sandboxing::get_platform_sandbox;
use core_test_support::PathExt;
use std::collections::HashMap;
use tempfile::TempDir;

fn skip_test() -> bool {
    if std::env::var(ATLAS_AGENT_SANDBOX_ENV_VAR) == Ok("seatbelt".to_string()) {
        eprintln!("{ATLAS_AGENT_SANDBOX_ENV_VAR} is set to 'seatbelt', skipping test.");
        return true;
    }
