...
use atlas_engine_connectors::metadata::connector_mention_slug;
...
use atlas_engine_skills::extract_tool_mentions_with_sigil;
use atlas_engine_skills::plugin_config_name_from_path;
