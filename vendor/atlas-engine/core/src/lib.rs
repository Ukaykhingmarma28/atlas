...
//! Root of the `atlas-engine-core` library.
...
pub use atlas_engine_protocol::turn_input::NotSubmittedReason;
pub use atlas_engine_protocol::turn_input::RecoverTurnRequest;
pub use atlas_engine_protocol::turn_input::StartIfIdleSubmission;
pub use atlas_engine_protocol::turn_input::SteerSubmission;
pub use atlas_engine_protocol::turn_input::TurnInput;
pub use atlas_engine_protocol::turn_input::TurnInputRequest;
pub use atlas_engine_protocol::turn_input::TurnInputSubmission;
pub use atlas_engine_protocol::turn_input::TurnStartOptions;
pub use responses_metadata::AtlasEngineResponsesMetadata;
pub use turn_metadata::detached_memory_responses_metadata;
mod atlas_engine_thread;
mod compact_model_fallback;
mod compact_remote;
mod compact_remote_history;
mod compact_remote_v2;
mod compact_token_budget;
pub use atlas_engine_protocol::protocol::EnvironmentConfig;
pub use atlas_engine_thread::BackgroundTerminalInfo;
pub use atlas_engine_thread::AtlasEngineThread;
pub use atlas_engine_thread::AtlasEngineThreadSettingsOverrides;
pub use atlas_engine_thread::ThreadConfigSnapshot;
...
pub use atlas_engine_mcp::AtlasAppsToolsCache;
pub use atlas_engine_mcp::SandboxState;
mod mcp_openai_file;
mod mcp_tool_call;
...
pub use atlas_engine_protocol::config_types::ModelProviderAuthInfo;
mod event_mapping;
pub use atlas_engine_prompts as review_prompts;
mod thread_manager;
...
#[deprecated(note = "use AtlasEngineThread")]
pub type AtlasEngineConversation = AtlasEngineThread;
...
pub use client::X_ATLAS_AGENT_INSTALLATION_ID_HEADER;
pub use client::X_ATLAS_AGENT_ROUTING_HINT_HEADER;
pub use client::X_ATLAS_AGENT_TURN_METADATA_HEADER;
pub use client_common::Prompt;
pub use client_common::ResponseEvent;
pub use client_common::ResponseStream;
pub use atlas_engine_prompts::REVIEW_PROMPT;
