...
use atlas_engine_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__atlas_engine_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__atlas_engine_powershell_script__";
