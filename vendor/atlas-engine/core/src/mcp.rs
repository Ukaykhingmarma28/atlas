...
use atlas_engine_connectors::PluginConnectorSource;
...
use atlas_engine_mcp::atlas_apps_mcp_server_config;
use atlas_engine_mcp::configured_mcp_servers;
...
const LEGACY_ATLAS_APPS_REGISTRATION_ID: &str = "legacy_atlas_apps";
...
impl McpManager {
    ...
    pub fn atlas_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.atlas_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_ATLAS_APPS_REGISTRATION_ID,
