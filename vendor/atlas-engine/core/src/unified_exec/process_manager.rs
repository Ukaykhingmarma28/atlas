...
use atlas_engine_protocol::protocol::TerminalInteractionEvent;
...
fn exec_server_env_for_request(
    ...
    Option<atlas_engine_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    tty: bool,
) -> atlas_engine_exec_server::ExecParams {
...
fn network_approval_error_message(err: ToolError) -> String {
    match err {
        ...
        ToolError::AtlasEngine(err) => err.to_string(),
    }
}
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<atlas_engine_network_proxy::RemoteNetworkProxyLaunchConfig>,
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == atlas_engine_sandboxing::SandboxType::WindowsRestrictedToken {
                    request
                        .network
                        .as_ref()
                        .map(|network| {
        ...
        let windows_sandbox =
            if request.sandbox == atlas_engine_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(atlas_engine_sandboxing::WindowsSandboxSpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::AtlasEngine(err) => match err.details() {
