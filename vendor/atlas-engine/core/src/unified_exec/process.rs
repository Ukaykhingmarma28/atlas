...
use atlas_engine_exec_server::ProcessSignal as ExecServerProcessSignal;
use atlas_engine_exec_server::ReadResponse as ExecReadResponse;
...
use atlas_engine_utils_pty::SpawnedPty;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = atlas_engine_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
