...
/// `atlas_engine_feedback::AtlasEngineFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// atlas_engine_core::feedback_tags!(model = "gpt-5", cached = true);
/// atlas_engine_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
