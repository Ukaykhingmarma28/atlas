...
use atlas_engine_protocol::models::ExecutedToolCall;
use atlas_engine_protocol::models::ResponseItem;
use atlas_engine_protocol::models::bound_executed_tool_calls_for_prompt_prioritizing_recent;
use atlas_engine_protocol::models::executed_tool_call_metadata_bytes;
...
impl ExecutedToolCallRecorder {
    pub(crate) fn record_tool_call(
        ...
        let name = atlas_engine_tools::code_mode_name_for_tool_name(&call.tool_name);
