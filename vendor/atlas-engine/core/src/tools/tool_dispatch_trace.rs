...
//!
//! `atlas-engine-rollout-trace` owns the event schema and writer behavior. This module
...
use atlas_engine_rollout_trace::ToolDispatchInvocation;
use atlas_engine_rollout_trace::ToolDispatchPayload;
use atlas_engine_rollout_trace::ToolDispatchRequester;
use atlas_engine_rollout_trace::ToolDispatchResult;
use atlas_engine_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        atlas_engine_turn_id: invocation.turn.sub_id.clone(),
