...
use atlas_engine_protocol::models::function_call_output_content_items_to_text;
use atlas_engine_tools::LoadableToolSpec;
...
pub use atlas_engine_tools::ToolOutput;
pub use atlas_engine_tools::ToolPayload;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Atlas Agent tool call id
