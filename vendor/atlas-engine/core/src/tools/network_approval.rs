...
use atlas_engine_network_proxy::BlockedRequest;
...
use atlas_engine_sandboxing::record_network_sandbox_violation;
...
pub(crate) async fn begin_network_approval(
    ...
    let execution_proxy = network
        ...
        .map_err(|err| {
            ToolError::AtlasEngine(atlas_engine_protocol::error::AtlasEngineErr::Io(io::Error::other(
