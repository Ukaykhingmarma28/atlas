    ...
    async fn handle_call(
        ...
        let result = match payload {
                    ...
                    && tool_name.name.as_str() == WAIT_TOOL_NAME =>
            {
                ...
                let cell_id = atlas_engine_code_mode::CellId::new(args.cell_id);
                let wait_response = if args.terminate {
                    ...
                    exec.session
                        .services
                        .code_mode_service
                        .wait(atlas_engine_code_mode::WaitRequest {
                            cell_id,
                ...
                if let atlas_engine_code_mode::WaitOutcome::LiveCell(response) = &wait_response {
        ...
        telemetry.finish(
            result
                .as_ref()
                .is_ok_and(atlas_engine_tools::ToolOutput::success_for_logging),
        );
        result
    }
}
