...
use atlas_engine_analytics::ArtifactOperation;
use atlas_engine_analytics::ArtifactOperationLifecycle;
...
use atlas_engine_core_plugins::recognize_artifact_operation;
use atlas_engine_otel::ARTIFACT_OPERATION_EXPECTED_OUTPUT_COUNT_METRIC;
use atlas_engine_otel::ARTIFACT_OPERATION_STARTED_METRIC;
...
use atlas_engine_protocol::items::CommandExecutionStatus;
        ...
        ctx.session
            ...
            .track_artifact_operation(
                ...
                ArtifactOperation {
                    ...
                    occurred_at_ms: atlas_engine_analytics::now_unix_millis(),
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::AtlasEngine(err)) => match err.details() {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = atlas_engine_apply_patch::apply_patch(
