...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: atlas_engine_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: atlas_engine_protocol::protocol::GuardianUserAuthorization,
