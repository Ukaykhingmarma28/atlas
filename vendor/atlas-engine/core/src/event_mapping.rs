...
use atlas_engine_protocol::items::WebSearchItem;
...
use atlas_engine_protocol::models::is_audio_close_tag_text;
use atlas_engine_protocol::models::is_audio_open_tag_text;
use atlas_engine_protocol::models::is_image_close_tag_text;
use atlas_engine_protocol::models::is_image_open_tag_text;
use atlas_engine_protocol::models::is_local_audio_close_tag_text;
use atlas_engine_protocol::models::is_local_audio_open_tag_text;
use atlas_engine_protocol::models::is_local_image_close_tag_text;
use atlas_engine_protocol::models::is_local_image_open_tag_text;
use atlas_engine_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
use atlas_engine_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use atlas_engine_protocol::protocol::CONTEXT_WINDOW_GUIDANCE_OPEN_TAG;
use atlas_engine_protocol::protocol::CONTEXT_WINDOW_OPEN_TAG;
...
use atlas_engine_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
...
use atlas_engine_protocol::protocol::TOOLS_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            atlas_engine_protocol::items::ImageGenerationItem {
