...
use atlas_engine_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth(auth: AtlasEngineAuth) -> Arc<AuthManager> {
...
) -> atlas_engine_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(atlas_agent_home, /*config_model_catalog*/ None)
}
...
#[derive(Clone, Copy)]
pub enum TestAtlasEngineResponsesRequestKind {
    Turn,
    Prewarm,
    WebsocketConnection,
}
...
pub fn responses_metadata(
    ...
    AtlasEngineResponsesMetadata {
        ...
        ..AtlasEngineResponsesMetadata::new(
