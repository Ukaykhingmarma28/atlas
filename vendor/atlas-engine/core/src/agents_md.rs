...
use atlas_engine_config::default_project_root_markers;
use atlas_engine_config::merge_toml_values;
use atlas_engine_config::project_root_markers_from_config;
...
impl LoadedAgentsMd {
    ...
    /// compile `atlas-engine-core` as a normal dependency without that configuration.
