...
//! inputs and the mutable [`atlas_engine_mcp::McpRuntime`]. Background scheduling
//! belongs elsewhere.
...
pub(super) struct McpDesiredState {
    ...
    pub(super) auth: Option<AtlasEngineAuth>,
...
impl Session {
    ...
    pub(super) fn build_mcp_runtime_input(
        ...
        config
            .environment_cwds
            .entry(atlas_engine_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string())
        ...
        McpRuntimeInput {
            ...
            runtime_context,
            atlas_apps_tools_cache: self.services.mcp_manager.atlas_apps_tools_cache(),
