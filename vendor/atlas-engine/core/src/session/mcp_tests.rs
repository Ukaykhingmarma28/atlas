...
fn plugin_install_elicitation_telemetry_metadata_requires_install_tool_suggestion() {
    let event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        ...
        id: atlas_engine_protocol::mcp::RequestId::String("request-1".to_string()),
        request: atlas_engine_protocol::approvals::ElicitationRequest::Form {
            meta: Some(json!({
    ...
    let enable_event = EventMsg::ElicitationRequest(ElicitationRequestEvent {
        turn_id: Some("turn-1".to_string()),
        server_name: "atlas_apps".to_string(),
        id: atlas_engine_protocol::mcp::RequestId::String("request-2".to_string()),
        request: atlas_engine_protocol::approvals::ElicitationRequest::Form {
            meta: Some(json!({
                "atlas_agent_approval_kind": "tool_suggestion",
                "suggest_type": "enable",
