...
use atlas_engine_skills::SkillError;
...
pub(crate) struct SessionConfiguration {
    ...
    /// Directory containing all Atlas Agent state for this session.
    pub(super) atlas_agent_home: AbsolutePathBuf,
...
impl SessionConfiguration {
    ...
    pub(crate) fn atlas_agent_home(&self) -> &AbsolutePathBuf {
    ...
    pub(super) fn validate(
        ...
        super::environment::validate_environment_selections(environments).map_err(|error| {
            ConstraintError::InvalidValue {
                ...
                requirement_source: atlas_engine_config::RequirementSource::Unknown,
            }
        })
    }
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        config: Arc<Config>,
        user_instructions: Option<atlas_engine_extension_api::UserInstructions>,
        ...
        code_mode_session_provider: Arc<dyn atlas_engine_code_mode::CodeModeSessionProvider>,
        extensions: Arc<atlas_engine_extension_api::ExtensionRegistry<crate::config::Config>>,
        ...
        windows_sandbox_proxy_settings_mode: atlas_engine_sandboxing::WindowsSandboxProxySettingsMode,
        ...
        thread_extension_init.insert(atlas_engine_extension_api::ThreadOriginator(
            session_configuration.originator.clone(),
        ));
        let mcp_thread_init = thread_extension_init.clone();
        let thread_extension_data = atlas_engine_extension_api::ExtensionData::new_with_init(
            thread_id.to_string(),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let config_path = config.atlas_agent_home.join(CONFIG_TOML_FILE);
            ...
            let account_id = telemetry_auth.and_then(AtlasEngineAuth::get_account_id);
            let account_email = telemetry_auth.and_then(AtlasEngineAuth::get_account_email);
            ...
            let mcp_server_names =
                atlas_engine_mcp::effective_mcp_servers(
            ...
            let session_extension_data =
                atlas_engine_extension_api::ExtensionData::new(session_id.to_string());
            ...
            for contributor in extensions.thread_lifecycle_contributors() {
                contributor.on_thread_start(atlas_engine_extension_api::ThreadStartInput {
                ...
                || mcp_auth_changes.has_changed().unwrap_or(false)
            {
                sess.services
                    .plugins_manager
                    .set_auth_mode(latest_auth.as_ref().map(AtlasEngineAuth::api_auth_mode));
                sess.services
                    .mcp_manager
                    .runtime_config_for_step(
                        config.as_ref(),
            ...
            let session_start_source = match &initial_history {
                InitialHistory::Resumed(_) => atlas_engine_hooks::SessionStartSource::Resume,
                InitialHistory::New | InitialHistory::Forked(_) => {
                    atlas_engine_hooks::SessionStartSource::Startup
                }
                InitialHistory::Cleared => atlas_engine_hooks::SessionStartSource::Clear,
            };
