...
use atlas_engine_prompts::render_review_exit_interrupted;
use atlas_engine_prompts::render_review_exit_success;
...
use atlas_engine_protocol::review_format::format_review_findings_block;
use atlas_engine_protocol::review_format::render_review_output_text;
use tokio_util::sync::CancellationToken;

use crate::atlas_engine_delegate::run_atlas_engine_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            .services
            .session_telemetry
            .counter("atlas_agent.task.review", /*inc*/ 1, &[]);
        ...
        // Start sub-atlas-agent conversation and get the receiver for events.
...
async fn start_review_conversation(
    ...
    (run_atlas_engine_thread_one_shot(
        sub_agent_config,
