...
use atlas_engine_protocol::models::snapshot_local_user_input;
...
use atlas_engine_protocol::protocol::ThreadQueueChangedEvent;
...
use atlas_engine_thread_store::MAX_QUEUE_ITEMS;
use atlas_engine_thread_store::QueueStore;
use atlas_engine_thread_store::QueuedUserSubmissionRecord;
...
pub enum QueueServiceError {
    ...
    CoreSubmissionError(#[from] AtlasEngineErr),
