...
use atlas_engine_config::bundled_skills_enabled_from_stack;
...
use atlas_engine_skills::LoadedSkills;
use atlas_engine_skills::SkillLoadFuture;
...
use atlas_engine_skills::install_system_skills;
...
impl HostSkillsService {
    ...
    pub fn new_with_restriction_product(
        ...
        // The cache is shared by every process using this ATLAS_AGENT_HOME. Disabled services filter
    ...
    fn ensure_system_skills_installed(&self) {
        if let Err(err) = install_system_skills(&self.atlas_agent_home) {
