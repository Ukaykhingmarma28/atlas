...
use atlas_engine_api::SearchInput;
...
use atlas_engine_tools::retain_tail_from_last_n_user_messages;
use atlas_engine_tools::truncate_assistant_output_text_to_token_budget;
