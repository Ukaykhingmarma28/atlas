...
use atlas_engine_connectors_extension::ExecutorPluginConnectorProvider;
use atlas_engine_core::config::Config;
use atlas_engine_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, atlas_engine_config::McpServerConfig)>,
