...
use atlas_engine_core_plugins::manifest::parse_plugin_manifest_uri;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &atlas_engine_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, atlas_engine_config::McpServerConfig)> {
