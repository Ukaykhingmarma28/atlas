...
//! Helpers for truncating tool and exec output using [`TruncationPolicy`](atlas_engine_protocol::protocol::TruncationPolicy).

use atlas_engine_protocol::models::FunctionCallOutputContentItem;
pub use atlas_engine_utils_string::approx_bytes_for_tokens;
pub use atlas_engine_utils_string::approx_token_count;
pub use atlas_engine_utils_string::approx_tokens_from_byte_count;
use atlas_engine_utils_string::truncate_middle_chars;
use atlas_engine_utils_string::truncate_middle_with_token_budget;

pub use atlas_engine_protocol::protocol::TruncationPolicy;
