...
//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across Atlas Agent
//! crates.
...
pub use atlas_engine_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
...
const PLUGIN_METADATA_DIR: &str = ".atlas-agent-plugin";
