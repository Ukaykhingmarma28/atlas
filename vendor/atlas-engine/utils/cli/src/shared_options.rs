...
//! Shared command-line flags used by both interactive and non-interactive Atlas Agent entry points.
...
pub struct SharedCliOptions {
    ...
    /// Layer $ATLAS_AGENT_HOME/<name>.config.toml on top of the base user config.
