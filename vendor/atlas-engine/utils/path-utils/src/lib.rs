...
//! Path normalization, symlink resolution, and atomic writes shared across Atlas Agent crates.
...
/// Compare paths after applying Atlas Agent's filesystem normalization.
///
