...
# atlas-engine-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Atlas Agent did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Atlas Agent on it. Feel free to update the documentation as you
modify the code
...
```rust
use atlas_engine_utils_stream_parser::CitationStreamParser;
use atlas_engine_utils_stream_parser::StreamTextParser;
...
```rust
use atlas_engine_utils_stream_parser::CitationStreamParser;
use atlas_engine_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), atlas_engine_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use atlas_engine_utils_stream_parser::InlineHiddenTagParser;
use atlas_engine_utils_stream_parser::InlineTagSpec;
use atlas_engine_utils_stream_parser::StreamTextParser;
