...
//! Write-path implementation for Atlas Agent memories.
//!
...
mod guard_limits {
    pub(super) const ATLAS_AGENT_LIMIT_ID: &str = "atlas-agent";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: atlas_engine_protocol::openai_models::ReasoningEffort =
        atlas_engine_protocol::openai_models::ReasoningEffort::Low;
