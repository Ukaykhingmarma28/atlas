...
//! `EscalateRequest` over the inherited `ATLAS_AGENT_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `ATLAS_AGENT_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use atlas_engine_protocol::approvals::EscalationPermissions;
pub use atlas_engine_protocol::approvals::ResolvedPermissionProfile;
