...
//!
//! This crate wraps [`atlas_engine_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](atlas_engine_app_server::in_process::InProcessClientHandle),
...
pub use atlas_engine_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use atlas_engine_app_server::in_process::InProcessServerEvent;
use atlas_engine_app_server::in_process::InProcessStartArgs;
use atlas_engine_app_server::in_process::LogDbLayer;
pub use atlas_engine_app_server::in_process::StateDbHandle;
...
use atlas_engine_app_server_protocol::Result as JsonRpcResult;
...
use atlas_engine_config::NoopThreadConfigLoader;
use atlas_engine_config::RemoteThreadConfigLoader;
use atlas_engine_config::ThreadConfigLoader;
use atlas_engine_core::config::Config;
pub use atlas_engine_core::otel_init::build_provider as build_otel_provider;
pub use atlas_engine_exec_server::EnvironmentManager;
pub use atlas_engine_exec_server::ExecServerRuntimePaths;
...
/// module exists so clients can remove a direct `atlas-engine-core` dependency
/// while legacy startup/config paths are migrated to RPCs.
pub mod legacy_core {
    pub mod config {
        pub use atlas_engine_core::config::*;

        pub mod edit {
            pub use atlas_engine_core::config::edit::*;
        }
    }
}
...
pub struct InProcessClientStartArgs {
    ...
    pub feedback: AtlasEngineFeedback,
    ...
    /// Whether auth loading should honor the `ATLAS_AGENT_API_KEY` environment variable.
    pub enable_atlas_engine_api_key_env: bool,
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_atlas_engine_api_key_env: self.enable_atlas_engine_api_key_env,
            initialize,
...
/// - [`atlas_engine_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    /// handshake.
    ///
    /// Added by Atlas; see `atlas_engine_app_server::in_process::start_with_external_auth`
    ...
    pub async fn start_with_external_auth(
        ...
        let mut handle = atlas_engine_app_server::in_process::start_with_external_auth(
...
mod tests {
    ...
    use atlas_engine_app_server_protocol::ServerNotification;
    use atlas_engine_app_server_protocol::SessionSource as ApiSessionSource;
    ...
    use atlas_engine_core::init_state_db;
    use atlas_engine_protocol::config_types::Personality;
    use atlas_engine_uds::UnixListener;
    use atlas_engine_utils_absolute_path::AbsolutePathBuf;
    use futures::SinkExt;
    ...
    async fn build_test_config_for_atlas_agent_home(atlas_agent_home: &Path) -> Config {
        ...
        {
            Ok(config) => config,
            Err(_) => Config::load_default_with_cli_overrides_for_atlas_agent_home(
    ...
    async fn start_test_client_with_capacity(
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "atlas-engine-app-server-client-test".to_string(),
        ...
        write_websocket_message(
            ...
            JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "atlas_agent/9.8.7-test (Test OS; x86_64) rust",
                    "atlasAgentHome": "/server/.atlas-agent",
                }),
            }),
        )
        .await;
    ...
    fn command_execution_output_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::CommandExecutionOutputDelta(
            atlas_engine_app_server_protocol::CommandExecutionOutputDeltaNotification {
    ...
    fn agent_message_delta_notification(delta: &str) -> ServerNotification {
        ServerNotification::AgentMessageDelta(
            atlas_engine_app_server_protocol::AgentMessageDeltaNotification {
                thread_id: "thread".to_string(),
                turn_id: "turn".to_string(),
                item_id: "item".to_string(),
                delta: delta.to_string(),
    ...
    async fn typed_request_reports_json_rpc_errors() {
        ...
        let err = client
            .request_typed::<ConfigRequirementsReadResponse>(ClientRequest::ThreadRead {
                ...
                params: atlas_engine_app_server_protocol::ThreadReadParams {
    ...
    async fn threads_started_via_app_server_are_visible_through_typed_requests() {
        ...
        let response: ThreadStartResponse = client
            ...
            .expect("thread/start should succeed");
        let read = client
            .request_typed::<atlas_engine_app_server_protocol::ThreadReadResponse>(
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        assert_eq!(client.atlas_agent_home(), Some("/server/.atlas-agent"));
        let response: GetAccountResponse = client
            .request_typed(ClientRequest::GetAccount {
                request_id: RequestId::Integer(1),
                params: atlas_engine_app_server_protocol::GetAccountParams {
                    refresh_token: false,
                },
            })
            .await
            ...
            match event {
                ...
                AppServerEvent::ServerNotification(notification) => match notification.as_ref() {
                    ...
                    ServerNotification::ItemCompleted(notification)
                        if matches!(
                            &notification.item,
                            atlas_engine_app_server_protocol::ThreadItem::AgentMessage { text, .. }
                                if text == "hello"
                        ) =>
                    {
                    ...
                    ServerNotification::TurnCompleted(notification)
                        if notification.turn.status
                            == atlas_engine_app_server_protocol::TurnStatus::Completed =>
                    {
    ...
    async fn runtime_start_args_use_remote_thread_config_loader_when_configured() {
        ...
        assert_eq!(
            err.code(),
            atlas_engine_config::ThreadConfigLoadErrorCode::RequestFailed
        );
    }
