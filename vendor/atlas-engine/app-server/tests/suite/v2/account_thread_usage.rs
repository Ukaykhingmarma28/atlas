...
use atlas_engine_app_server_protocol::ThreadUsage;
use atlas_engine_app_server_protocol::ThreadUsageBreakdownGroup;
...
async fn account_thread_usage_uses_active_workspace_and_canonical_thread_ids() -> Result<()> {
    ...
    Mock::given(method("POST"))
        .and(path("/api/atlas-agent/usage/thread_usage/query"))
