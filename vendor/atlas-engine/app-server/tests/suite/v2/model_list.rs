...
use atlas_engine_app_server_protocol::Model;
use atlas_engine_app_server_protocol::ModelListParams;
use atlas_engine_app_server_protocol::ModelListResponse;
use atlas_engine_app_server_protocol::ModelServiceTier;
use atlas_engine_app_server_protocol::ModelUpgradeInfo;
use atlas_engine_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        atlas_engine_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
