...
fn standalone_app_server_emits_json_info_events() -> Result<()> {
    ...
    assert_eq!(
        ...
        json!({
            ...
            "target": "atlas_engine_app_server",
        })
    );
...
async fn app_server_emits_structured_tool_call_timing_event() -> Result<()> {
    ...
    let mut app_server = TestAppServer::builder()
        ...
        .with_json_logging("warn,atlas_engine_core::tools::parallel=info")
        .build_initialized()
        .await?;
    ...
    let mut tool_call = app_server
        .wait_for_json_log_event("atlas_agent.tool_call")
        .await?;
    ...
    assert_eq!(
        ...
        json!({
            ...
            "target": "atlas_engine_core::tools::parallel",
        })
    );
