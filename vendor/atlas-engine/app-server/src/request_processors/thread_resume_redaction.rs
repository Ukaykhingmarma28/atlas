...
use atlas_engine_app_server_protocol::McpToolCallResult;
...
const CHATGPT_REMOTE_CLIENT_NAMES: &[&str] =
    &["atlas_engine_chatgpt_android_remote", "atlas_engine_chatgpt_ios_remote"];
...
mod tests {
    ...
    use atlas_engine_app_server_protocol::McpToolCallError;
