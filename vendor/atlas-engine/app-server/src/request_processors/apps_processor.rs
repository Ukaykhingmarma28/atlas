...
impl AppsRequestProcessor {
    ...
    async fn apps_list_task(
        ...
        let should_retry = result
            .as_ref()
            .is_ok_and(|(_, atlas_apps_ready)| !atlas_apps_ready);
        outgoing
        ...
        loop {
            ...
            match result {
                AppListLoadResult::Accessible(Ok(status)) => {
                    ...
                    atlas_apps_ready = status.atlas_apps_ready;
                }
            ...
            if accessible_loaded && all_loaded {
                ...
                return Ok((response, atlas_apps_ready));
            }
        }
    }
...
const APPS_INSTALLED_DURATION_METRIC: &str = "atlas_agent.apps.installed.duration_ms";
