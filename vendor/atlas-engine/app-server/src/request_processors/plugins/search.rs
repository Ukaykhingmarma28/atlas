...
use atlas_engine_app_server_protocol::PluginSearchResult;
use atlas_engine_app_server_protocol::PluginSearchScope;
use atlas_engine_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use atlas_engine_core_plugins::remote::RemotePluginSearchRequest;
use atlas_engine_core_plugins::remote::search_remote_plugins;
...
impl PluginRequestProcessor {
    ...
    async fn plugin_search_response(
        ...
        if auth_mode.is_some_and(DomainAuthMode::uses_atlas_engine_backend)
