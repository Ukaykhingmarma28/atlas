...
use atlas_engine_app_server_protocol::AutoReviewRequirements;
use atlas_engine_app_server_protocol::BrowserUseRequirements;
use atlas_engine_app_server_protocol::ClientResponsePayload;
use atlas_engine_app_server_protocol::ComputerUseRequirements;
...
use atlas_engine_app_server_protocol::ConfigRequirements;
...
use atlas_engine_app_server_protocol::ConfigWriteErrorCode;
use atlas_engine_app_server_protocol::ConfigWriteResponse;
use atlas_engine_app_server_protocol::ConfiguredHookHandler;
use atlas_engine_app_server_protocol::ConfiguredHookMatcherGroup;
use atlas_engine_app_server_protocol::ExperimentalFeatureEnablementSetParams;
use atlas_engine_app_server_protocol::ExperimentalFeatureEnablementSetResponse;
use atlas_engine_app_server_protocol::FeedbackRequirements;
use atlas_engine_app_server_protocol::JSONRPCErrorError;
use atlas_engine_app_server_protocol::ManagedHooksRequirements;
use atlas_engine_app_server_protocol::ModelProviderCapabilitiesReadResponse;
use atlas_engine_app_server_protocol::ModelsRequirements;
use atlas_engine_app_server_protocol::NetworkDomainPermission;
use atlas_engine_app_server_protocol::NetworkRequirements;
use atlas_engine_app_server_protocol::NetworkUnixSocketPermission;
use atlas_engine_app_server_protocol::NewThreadModelDefaults;
...
use atlas_engine_config::HookEventsToml;
use atlas_engine_config::HookHandlerConfig as CoreHookHandlerConfig;
use atlas_engine_config::ManagedHooksRequirementsToml;
use atlas_engine_config::MatcherGroup as CoreMatcherGroup;
use atlas_engine_config::ResidencyRequirement as CoreResidencyRequirement;
use atlas_engine_config::SandboxModeRequirement as CoreSandboxModeRequirement;
use atlas_engine_core::ThreadManager;
use atlas_engine_features::canonical_feature_for_key;
use atlas_engine_features::feature_for_key;
...
impl ConfigRequestProcessor {
    ...
    ) -> Result<atlas_engine_core::config::Config, JSONRPCErrorError> {
        self.config_manager
    ...
    async fn write_value(
        ...
        let pending_changes = atlas_engine_core_plugins::toggles::collect_plugin_enabled_candidates(
...
fn map_requirements_toml_to_api(requirements: ConfigRequirementsToml) -> ConfigRequirements {
    ...
    ConfigRequirements {
        allowed_approval_policies: requirements.allowed_approval_policies.map(|policies| {
            policies
                .into_iter()
                .map(atlas_engine_app_server_protocol::AskForApproval::from)
                .collect()
        }),
        allowed_approvals_reviewers: requirements.allowed_approvals_reviewers.map(|reviewers| {
            reviewers
                .into_iter()
                .map(atlas_engine_app_server_protocol::ApprovalsReviewer::from)
                .collect()
        }),
                ...
                .map(|implementations| {
                    implementations
                        ...
                        .map(|implementation| match implementation {
                            atlas_engine_config::types::WindowsSandboxModeToml::Elevated => {
                                WindowsSandboxSetupMode::Elevated
                            }
                            atlas_engine_config::types::WindowsSandboxModeToml::Unelevated => {
...
fn map_computer_use_requirements_to_api(
    computer_use: atlas_engine_config::ComputerUseRequirementsToml,
...
fn map_browser_use_requirements_to_api(
    browser_use: atlas_engine_config::BrowserUseRequirementsToml,
...
) -> atlas_engine_app_server_protocol::ResidencyRequirement {
    match residency {
        CoreResidencyRequirement::Us => atlas_engine_app_server_protocol::ResidencyRequirement::Us,
    }
}

fn map_network_requirements_to_api(
    network: atlas_engine_config::NetworkRequirementsToml,
) -> NetworkRequirements {
    let allowed_domains = network
        .domains
        .as_ref()
        .and_then(atlas_engine_config::NetworkDomainPermissionsToml::allowed_domains);
    let denied_domains = network
        .domains
        .as_ref()
        .and_then(atlas_engine_config::NetworkDomainPermissionsToml::denied_domains);
    let allow_unix_sockets = network
        .unix_sockets
        .as_ref()
        .map(atlas_engine_config::NetworkUnixSocketPermissionsToml::allow_unix_sockets)
...
fn map_network_domain_permission_to_api(
    permission: atlas_engine_config::NetworkDomainPermissionToml,
) -> NetworkDomainPermission {
    match permission {
        atlas_engine_config::NetworkDomainPermissionToml::Allow => NetworkDomainPermission::Allow,
        atlas_engine_config::NetworkDomainPermissionToml::Deny => NetworkDomainPermission::Deny,
    }
}
...
mod tests {
    ...
    use atlas_engine_app_server_protocol::FeedbackRequirements;
    use atlas_engine_app_server_protocol::WindowsSandboxSetupMode;
    use atlas_engine_config::AutoReviewRequirementsToml;
    use atlas_engine_config::ComputerUseRequirementsToml;
    use atlas_engine_config::ConfigRequirementsToml;
    use atlas_engine_config::ModelsRequirementsToml;
    use atlas_engine_config::NewThreadModelDefaultsToml;
    use atlas_engine_config::WindowsRequirementsToml;
