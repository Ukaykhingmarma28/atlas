...
use atlas_engine_queue_extension::QueueServiceError;
use atlas_engine_queue_extension::QueuedItem;
...
impl ThreadQueueRequestProcessor {
    ...
    async fn require_thread(
        &self,
        raw_thread_id: &str,
    ) -> Result<(ThreadId, Option<Arc<AtlasEngineThread>>, SessionSource), JSONRPCErrorError> {
...
fn ensure_direct_input_allowed(
    loaded_thread: Option<&AtlasEngineThread>,
