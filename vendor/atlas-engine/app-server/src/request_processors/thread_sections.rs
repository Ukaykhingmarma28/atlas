...
use atlas_engine_app_server_protocol::ThreadSectionCreateResponse;
use atlas_engine_app_server_protocol::ThreadSectionDeleteParams;
use atlas_engine_app_server_protocol::ThreadSectionDeleteResponse;
use atlas_engine_app_server_protocol::ThreadSectionListParams;
use atlas_engine_app_server_protocol::ThreadSectionListResponse;
use atlas_engine_app_server_protocol::ThreadSectionUpdateParams;
use atlas_engine_app_server_protocol::ThreadSectionUpdateResponse;
use atlas_engine_state::PINNED_THREAD_SECTION_ID;
use atlas_engine_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use atlas_engine_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use atlas_engine_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use atlas_engine_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
use atlas_engine_thread_store::StoredThreadSection;
...
fn state_thread_section_appearance(
    appearance: ThreadSectionAppearance,
) -> atlas_engine_state::ThreadSectionAppearance {
    atlas_engine_state::ThreadSectionAppearance {
        icon: appearance.icon,
        color: appearance.color,
    }
