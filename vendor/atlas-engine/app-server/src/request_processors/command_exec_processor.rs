...
use super::*;
use atlas_engine_core::exec_env::inject_apply_patch_env;
    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                atlas_engine_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                atlas_engine_protocol::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                atlas_engine_protocol::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    atlas_engine_protocol::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let exec_params = ExecParams {
            ...
            network: started_network_proxy
                .as_ref()
                .map(atlas_engine_core::config::StartedNetworkProxy::proxy),
        ...
        let atlas_engine_linux_sandbox_exe = self.arg0_paths.atlas_engine_linux_sandbox_exe.clone();
        ...
        let exec_request = atlas_engine_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
