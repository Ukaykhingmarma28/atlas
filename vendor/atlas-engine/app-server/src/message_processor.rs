...
use atlas_engine_app_server_protocol::experimental_required_message;
...
use atlas_engine_thread_store::LocalQueueStore;
use atlas_engine_thread_store::QueueStore;
...
pub(crate) struct MessageProcessorArgs {
    ...
    pub(crate) feedback: AtlasEngineFeedback,
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let thread_manager = Arc::new_cyclic(|thread_manager| {
            ...
            let manager = ThreadManager::new(
                config.as_ref(),
                auth_manager.clone(),
                atlas_engine_core::build_models_manager(config.as_ref(), auth_manager.clone()),
    ...
    pub(crate) async fn process_request(
        ...
        Self::run_request_with_context(
            ...
            async {
                let atlas_engine_request = deserialize_client_request(request);
                let result = match atlas_engine_request {
                    Ok(atlas_engine_request) => {
    ...
    async fn handle_client_request(
        ...
        atlas_engine_request: ClientRequest,
        session: Arc<ConnectionSessionState>,
        ...
        if let ClientRequest::Initialize { request_id, params } = atlas_engine_request {
    ...
    async fn dispatch_initialized_client_request(
        ...
        if let Some(reason) = atlas_engine_request.experimental_reason()
        ...
        let serialization_scope = atlas_engine_request.serialization_scope();
