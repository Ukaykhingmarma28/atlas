...
use atlas_engine_app_server_protocol::AccountRateLimitsUpdatedNotification;
use atlas_engine_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use atlas_engine_app_server_protocol::AtlasEngineErrorInfo as V2AtlasEngineErrorInfo;
use atlas_engine_app_server_protocol::CommandAction as V2ParsedCommand;
use atlas_engine_app_server_protocol::CommandExecutionApprovalDecision;
use atlas_engine_app_server_protocol::CommandExecutionPresentation;
...
use atlas_engine_app_server_protocol::EnvironmentConnectionNotification;
use atlas_engine_app_server_protocol::ErrorNotification;
use atlas_engine_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use atlas_engine_app_server_protocol::FileChangeApprovalDecision;
use atlas_engine_app_server_protocol::FileChangeRequestApprovalParams;
use atlas_engine_app_server_protocol::FileChangeRequestApprovalResponse;
use atlas_engine_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use atlas_engine_app_server_protocol::GuardianWarningNotification;
use atlas_engine_app_server_protocol::HookCompletedNotification;
use atlas_engine_app_server_protocol::HookStartedNotification;
...
use atlas_engine_app_server_protocol::McpServerElicitationAction;
use atlas_engine_app_server_protocol::McpServerElicitationRequestParams;
use atlas_engine_app_server_protocol::McpServerElicitationRequestResponse;
use atlas_engine_app_server_protocol::McpServerStartupState;
use atlas_engine_app_server_protocol::McpServerStatusUpdatedNotification;
use atlas_engine_app_server_protocol::ModelReroutedNotification;
use atlas_engine_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use atlas_engine_app_server_protocol::ModelVerificationNotification;
use atlas_engine_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use atlas_engine_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use atlas_engine_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
...
use atlas_engine_app_server_protocol::RawResponseItemCompletedNotification;
...
use atlas_engine_app_server_protocol::ThreadRealtimeClosedNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeErrorNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeItemAddedNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeSdpNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeStartedNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use atlas_engine_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use atlas_engine_app_server_protocol::ThreadRollbackResponse;
use atlas_engine_app_server_protocol::ThreadSettingsUpdatedNotification;
use atlas_engine_app_server_protocol::ThreadStatus;
use atlas_engine_app_server_protocol::ThreadTokenUsage;
use atlas_engine_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use atlas_engine_app_server_protocol::ToolRequestUserInputOption;
use atlas_engine_app_server_protocol::ToolRequestUserInputParams;
use atlas_engine_app_server_protocol::ToolRequestUserInputQuestion;
use atlas_engine_app_server_protocol::ToolRequestUserInputResponse;
...
use atlas_engine_app_server_protocol::TurnModerationMetadataNotification;
use atlas_engine_app_server_protocol::TurnPlanStep;
use atlas_engine_app_server_protocol::TurnPlanUpdatedNotification;
...
use atlas_engine_app_server_protocol::build_item_from_guardian_event;
use atlas_engine_app_server_protocol::guardian_auto_approval_review_notification;
use atlas_engine_app_server_protocol::item_event_to_server_notification;
use atlas_engine_core::AtlasEngineThread;
use atlas_engine_core::ThreadManager;
use atlas_engine_protocol::ThreadId;
use atlas_engine_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use atlas_engine_protocol::items::TurnItem as CoreTurnItem;
use atlas_engine_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use atlas_engine_protocol::plan_tool::UpdatePlanArgs;
use atlas_engine_protocol::protocol::AtlasEngineErrorInfo as CoreAtlasEngineErrorInfo;
...
use atlas_engine_protocol::protocol::SubAgentActivityKind;
...
use atlas_engine_protocol::protocol::TurnDiffEvent;
...
use atlas_engine_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use atlas_engine_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use atlas_engine_sandboxing::policy_transforms::intersect_permission_profiles;
use atlas_engine_shell_command::parse_command::shlex_join;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<AtlasEngineThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                atlas_engine_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                atlas_engine_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                atlas_engine_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                atlas_engine_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            let completion_status = match assessment.status {
                atlas_engine_protocol::protocol::GuardianAssessmentStatus::Denied
                | atlas_engine_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                atlas_engine_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                atlas_engine_protocol::protocol::GuardianAssessmentStatus::InProgress
                | atlas_engine_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: atlas_engine_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let atlas_engine_error_info = ev.atlas_engine_error_info.clone();
            ...
            if matches!(
                ...
                Some(CoreAtlasEngineErrorInfo::ThreadRollbackFailed)
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: atlas_engine_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: atlas_engine_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: atlas_engine_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<AtlasEngineThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: atlas_engine_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            atlas_engine_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
async fn on_file_change_request_approval_response(
    ...
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    atlas_engine: Arc<AtlasEngineThread>,
    thread_state: Arc<Mutex<ThreadState>>,
    permission_guard: ThreadWatchActiveGuard,
) {
    let response = receiver.await;
...
mod tests {
    ...
    use atlas_engine_app_server_protocol::TurnPlanStepStatus;
    use atlas_engine_login::AtlasEngineAuth;
    use atlas_engine_protocol::AgentPath;
    use atlas_engine_protocol::items::AgentMessageContent as CoreAgentMessageContent;
    use atlas_engine_protocol::items::AgentMessageItem as CoreAgentMessageItem;
    use atlas_engine_protocol::items::DynamicToolCallItem;
    use atlas_engine_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use atlas_engine_protocol::items::SubAgentActivityItem;
    use atlas_engine_protocol::items::TurnItem as CoreTurnItem;
    use atlas_engine_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use atlas_engine_protocol::plan_tool::PlanItemArg;
    use atlas_engine_protocol::plan_tool::StepStatus;
    use atlas_engine_protocol::protocol::AgentMessageEvent;
    use atlas_engine_protocol::protocol::AskForApproval;
    use atlas_engine_protocol::protocol::CreditsSnapshot;
    use atlas_engine_protocol::protocol::EventMsg;
    use atlas_engine_protocol::protocol::GuardianAssessmentEvent;
    use atlas_engine_protocol::protocol::GuardianAssessmentStatus;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: atlas_engine_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(atlas_engine_protocol::protocol::GuardianRiskLevel::Low),
                Some(atlas_engine_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(atlas_engine_protocol::protocol::GuardianRiskLevel::High),
                Some(atlas_engine_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(atlas_engine_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = atlas_engine_protocol::protocol::GuardianAssessmentAction::Command {
            source: atlas_engine_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: atlas_engine_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(atlas_engine_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(atlas_engine_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = atlas_engine_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: atlas_engine_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: atlas_engine_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&atlas_agent_home).await;
        let thread_manager = Arc::new(
            atlas_engine_core::test_support::thread_manager_with_models_provider_and_home(
        ...
        let atlas_engine_core::NewThread {
            thread_id: conversation_id,
            thread: conversation,
            ..
        } = thread_manager
            .start_thread(atlas_engine_core::StartThreadOptions::new(config.clone()))
            .await?;
        let thread_state = new_thread_state();
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(atlas_engine_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(atlas_engine_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(atlas_engine_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: atlas_engine_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("atlas-agent"));
