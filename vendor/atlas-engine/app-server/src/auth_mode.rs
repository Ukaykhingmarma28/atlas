...
use atlas_engine_app_server_protocol::AuthMode as ApiAuthMode;
use atlas_engine_protocol::auth::AuthMode;

/// Converts the domain auth mode owned by `atlas-engine-protocol` into the app-server wire type owned by
