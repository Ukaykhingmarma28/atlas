...
use atlas_engine_external_agent_migration::ExternalAgentConfigImportItemResult;
use atlas_engine_external_agent_migration::record_import_error;
use atlas_engine_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use atlas_engine_external_agent_migration::sessions::ExistingSessionAppend;
use atlas_engine_external_agent_migration::sessions::ExternalAgentSessionMigration;
use atlas_engine_external_agent_migration::sessions::ImportedExternalAgentSession;
use atlas_engine_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use atlas_engine_external_agent_migration::sessions::PendingSessionImport;
use atlas_engine_external_agent_migration::sessions::SessionImportTarget;
use atlas_engine_external_agent_migration::sessions::SessionMetadataMode;
use atlas_engine_external_agent_migration::sessions::append_existing_session;
use atlas_engine_external_agent_migration::sessions::append_imported_session_connector_names;
use atlas_engine_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use atlas_engine_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use atlas_engine_external_agent_migration::sessions::record_completed_session_imports;
...
use atlas_engine_thread_store::AppendThreadItemsParams;
...
impl ExternalAgentSessionImporter {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: atlas_engine_login::default_client::originator().value,
