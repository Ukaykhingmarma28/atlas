...
use atlas_engine_analytics::ExternalAgentConfigImportCompletedInput;
use atlas_engine_analytics::ExternalAgentConfigImportFailureInput;
use atlas_engine_app_server_protocol::ExternalAgentConfigDetectParams;
...
use atlas_engine_app_server_protocol::ExternalAgentConfigImportHistoryRecordParams;
use atlas_engine_app_server_protocol::ExternalAgentConfigImportHistoryRecordResponse;
use atlas_engine_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use atlas_engine_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
use atlas_engine_app_server_protocol::ExternalAgentConfigImportParams;
...
use atlas_engine_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
use atlas_engine_app_server_protocol::ExternalAgentConfigMigrationItem;
...
use atlas_engine_external_agent_migration::DetectedConnectorCandidate;
use atlas_engine_external_agent_migration::ExternalAgentConfigDetectOptions;
use atlas_engine_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use atlas_engine_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use atlas_engine_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use atlas_engine_external_agent_migration::ExternalAgentConfigService;
use atlas_engine_external_agent_migration::ExternalAgentSessionImportLimits;
use atlas_engine_external_agent_migration::PluginImportOutcome;
use atlas_engine_external_agent_migration::record_import_error;
use atlas_engine_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use atlas_engine_external_agent_migration::sessions::read_imported_connector_candidates;
use atlas_engine_external_agent_migration::sessions::record_detected_session_connectors;
use atlas_engine_features::Feature;
use atlas_engine_rollout::StateDbHandle;
use atlas_engine_state::ExternalAgentConfigImportFailureRecord;
use atlas_engine_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) atlas_agent_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn detect(
        ...
        record_detected_session_connectors(
            self.migration_service.atlas_agent_home(),
