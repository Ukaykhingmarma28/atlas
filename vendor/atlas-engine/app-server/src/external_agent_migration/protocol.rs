...
use atlas_engine_app_server_protocol::CommandMigration;
...
use atlas_engine_app_server_protocol::ExternalAgentConfigImportHistory;
...
use atlas_engine_app_server_protocol::ExternalAgentDetectedConnectorCandidate;
use atlas_engine_app_server_protocol::ExternalAgentDetectedConnectorSource;
use atlas_engine_app_server_protocol::HookMigration;
use atlas_engine_app_server_protocol::JSONRPCErrorError;
use atlas_engine_app_server_protocol::McpServerMigration;
use atlas_engine_app_server_protocol::MigrationDetails;
use atlas_engine_app_server_protocol::PluginsMigration;
use atlas_engine_app_server_protocol::SkillMigration;
use atlas_engine_app_server_protocol::SubagentMigration;
use atlas_engine_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use atlas_engine_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use atlas_engine_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use atlas_engine_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use atlas_engine_external_agent_migration::ExternalAgentConfigImportSuccess;
use atlas_engine_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use atlas_engine_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use atlas_engine_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use atlas_engine_external_agent_migration::NamedMigration;
use atlas_engine_external_agent_migration::PluginsMigration as CorePluginsMigration;
use atlas_engine_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
pub(super) fn protocol_import_history(
    record: atlas_engine_state::ExternalAgentConfigImportHistoryRecord,
