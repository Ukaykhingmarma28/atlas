...
use atlas_engine_file_watcher::FileWatcher;
use atlas_engine_file_watcher::FileWatcherSubscriber;
use atlas_engine_file_watcher::Receiver;
use atlas_engine_file_watcher::ThrottledWatchReceiver;
use atlas_engine_file_watcher::WatchPath;
...
impl SkillsWatcher {
    pub(crate) fn new(
        ...
        let system_skills_root = system_cache_root_dir(atlas_agent_home);
