...
use atlas_engine_protocol::items::parse_hook_prompt_message;
use atlas_engine_protocol::models::MessagePhase;
use atlas_engine_protocol::protocol::AgentReasoningEvent;
use atlas_engine_protocol::protocol::AgentReasoningRawContentEvent;
use atlas_engine_protocol::protocol::AgentStatus;
use atlas_engine_protocol::protocol::ApplyPatchApprovalRequestEvent;
use atlas_engine_protocol::protocol::ContextCompactedEvent;
use atlas_engine_protocol::protocol::DynamicToolCallResponseEvent;
use atlas_engine_protocol::protocol::ErrorEvent;
use atlas_engine_protocol::protocol::EventMsg;
use atlas_engine_protocol::protocol::ExecCommandBeginEvent;
use atlas_engine_protocol::protocol::ExecCommandEndEvent;
...
use atlas_engine_protocol::protocol::McpToolCallEndEvent;
use atlas_engine_protocol::protocol::PatchApplyBeginEvent;
use atlas_engine_protocol::protocol::PatchApplyEndEvent;
...
use atlas_engine_protocol::protocol::ViewImageToolCallEvent;
use atlas_engine_protocol::protocol::WebSearchBeginEvent;
use atlas_engine_protocol::protocol::WebSearchEndEvent;
#[cfg(test)]
use atlas_engine_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
use atlas_engine_rollout::CompactedItem;
...
#[cfg(test)]
use atlas_engine_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
#[cfg(test)]
use atlas_engine_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `atlas-engine-rs/core/rollout/policy.rs`.
    ...
    fn handle_response_item(&mut self, item: &atlas_engine_protocol::models::ResponseItem) {
    ...
    fn handle_materialized_item_lifecycle(
        &mut self,
        turn_id: &str,
        item: &atlas_engine_protocol::items::TurnItem,
    ) {
        let is_review_mode_item = matches!(
            item,
            atlas_engine_protocol::items::TurnItem::EnteredReviewMode(_)
                | atlas_engine_protocol::items::TurnItem::ExitedReviewMode(_)
        );
        let should_upsert = match item {
            atlas_engine_protocol::items::TurnItem::Plan(plan) => !plan.text.is_empty(),
            atlas_engine_protocol::items::TurnItem::HookPrompt(_)
            | atlas_engine_protocol::items::TurnItem::CommandExecution(_)
            | atlas_engine_protocol::items::TurnItem::DynamicToolCall(_)
            | atlas_engine_protocol::items::TurnItem::CollabAgentToolCall(_)
            | atlas_engine_protocol::items::TurnItem::SubAgentActivity(_)
            | atlas_engine_protocol::items::TurnItem::Extension(_)
            | atlas_engine_protocol::items::TurnItem::EnteredReviewMode(_)
            | atlas_engine_protocol::items::TurnItem::ExitedReviewMode(_) => true,
            atlas_engine_protocol::items::TurnItem::UserMessage(_)
            | atlas_engine_protocol::items::TurnItem::AgentMessage(_)
            | atlas_engine_protocol::items::TurnItem::Reasoning(_)
            | atlas_engine_protocol::items::TurnItem::WebSearch(_)
            | atlas_engine_protocol::items::TurnItem::ImageView(_)
            | atlas_engine_protocol::items::TurnItem::ImageGeneration(_)
            | atlas_engine_protocol::items::TurnItem::FileChange(_)
            | atlas_engine_protocol::items::TurnItem::McpToolCall(_)
            | atlas_engine_protocol::items::TurnItem::ContextCompaction(_) => false,
        };
    ...
    fn handle_dynamic_tool_call_request(
        &mut self,
        payload: &atlas_engine_protocol::dynamic_tools::DynamicToolCallRequest,
    ) {
    ...
    fn handle_collab_agent_spawn_begin(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabAgentSpawnBeginEvent,
    ) {
    ...
    fn handle_collab_agent_spawn_end(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabAgentSpawnEndEvent,
    ) {
    ...
    fn handle_collab_agent_interaction_begin(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabAgentInteractionBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_agent_interaction_end(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabAgentInteractionEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
    ...
    fn handle_sub_agent_activity(
        &mut self,
        payload: &atlas_engine_protocol::protocol::SubAgentActivityEvent,
    ) {
    ...
    fn handle_collab_waiting_begin(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabWaitingBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_waiting_end(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabWaitingEndEvent,
    ) {
    ...
    fn handle_collab_close_begin(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabCloseBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_begin(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabResumeBeginEvent,
    ) {
        let item = ThreadItem::CollabAgentToolCall {
            id: payload.call_id.clone(),
    ...
    fn handle_collab_resume_end(
        &mut self,
        payload: &atlas_engine_protocol::protocol::CollabResumeEndEvent,
    ) {
        let status = match &payload.status {
            AgentStatus::Errored(_) | AgentStatus::NotFound => CollabAgentToolCallStatus::Failed,
            _ => CollabAgentToolCallStatus::Completed,
    ...
    fn handle_entered_review_mode(
        &mut self,
        payload: &atlas_engine_protocol::protocol::EnteredReviewModeEvent,
    ) {
        let review = payload
            .user_facing_hint
            .clone()
    ...
    fn handle_exited_review_mode(
        &mut self,
        payload: &atlas_engine_protocol::protocol::ExitedReviewModeEvent,
    ) {
...
fn convert_dynamic_tool_content_items(
    items: &[atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem],
) -> Vec<DynamicToolCallOutputContentItem> {
    items
        .iter()
        .cloned()
        .map(|item| match item {
            atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputText { text } => {
                DynamicToolCallOutputContentItem::InputText { text }
            }
            atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputImage {
                image_url,
            } => DynamicToolCallOutputContentItem::InputImage { image_url },
            atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem::InputAudio {
                audio_url,
...
mod tests {
    ...
    use atlas_engine_extension_items::ExtensionItem as CoreExtensionItem;
    use atlas_engine_extension_items::sleep::SleepItem as CoreSleepItem;
    use atlas_engine_protocol::ThreadId;
    use atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
    use atlas_engine_protocol::items::CommandExecutionItem as CoreCommandExecutionItem;
    use atlas_engine_protocol::items::CommandExecutionStatus as CoreCommandExecutionStatus;
    use atlas_engine_protocol::items::EnteredReviewModeItem as CoreEnteredReviewModeItem;
    use atlas_engine_protocol::items::ExitedReviewModeItem as CoreExitedReviewModeItem;
    use atlas_engine_protocol::items::HookPromptFragment as CoreHookPromptFragment;
    use atlas_engine_protocol::items::TurnItem as CoreTurnItem;
    use atlas_engine_protocol::items::UserMessageItem as CoreUserMessageItem;
    ...
    use atlas_engine_protocol::models::MessagePhase as CoreMessagePhase;
    use atlas_engine_protocol::models::WebSearchAction as CoreWebSearchAction;
    use atlas_engine_protocol::parse_command::ParsedCommand;
    ...
    use atlas_engine_protocol::protocol::DynamicToolCallResponseEvent;
    use atlas_engine_protocol::protocol::EnteredReviewModeEvent;
    use atlas_engine_protocol::protocol::ExecCommandBeginEvent;
    use atlas_engine_protocol::protocol::ExecCommandEndEvent;
    use atlas_engine_protocol::protocol::ExecCommandSource;
    use atlas_engine_protocol::protocol::ExitedReviewModeEvent;
    use atlas_engine_protocol::protocol::ItemStartedEvent;
    use atlas_engine_protocol::protocol::McpInvocation;
    use atlas_engine_protocol::protocol::McpToolCallEndEvent;
    use atlas_engine_protocol::protocol::PatchApplyBeginEvent;
    use atlas_engine_protocol::protocol::ReviewTarget;
    use atlas_engine_protocol::protocol::ThreadRolledBackEvent;
        ...
        let events = vec![
            ...
            EventMsg::ItemStarted(ItemStartedEvent {
                ...
                item: CoreTurnItem::UserMessage(CoreUserMessageItem {
                    ...
                    content: vec![atlas_engine_protocol::user_input::UserInput::Text {
                        text: "hello".into(),
                        text_elements: Vec::new(),
                    }],
                }),
    ...
    fn replays_image_generation_end_events_into_turn_history() {
        let items = vec![
            ...
            RolloutItem::EventMsg(EventMsg::ImageGenerationEnd(ImageGenerationEndEvent {
                ...
                transparent_background: Some(true),
                failure: Some(
                    atlas_engine_extension_items::image_generation::ImageGenerationFailure::UsageLimitExceeded {
    ...
    fn reconstructs_tool_items_from_persisted_completion_events() {
        let events = vec![
            ...
            EventMsg::WebSearchEnd(WebSearchEndEvent {
                ...
                query: "atlas-agent".into(),
                action: CoreWebSearchAction::Search {
                    query: Some("atlas-agent".into()),
                    queries: None,
                },
    ...
    fn reconstructs_dynamic_tool_items_from_request_and_response_events() {
        let events = vec![
            ...
            EventMsg::DynamicToolCallRequest(
                atlas_engine_protocol::dynamic_tools::DynamicToolCallRequest {
                    call_id: "dyn-1".into(),
                    turn_id: "turn-1".into(),
                    started_at_ms: 0,
                    namespace: Some("atlas_engine_app".into()),
        ...
        let events = vec![
            ...
            EventMsg::PatchApplyEnd(PatchApplyEndEvent {
                ...
                changes: [(
                    ...
                    atlas_engine_protocol::protocol::FileChange::Add {
                        content: "hello\n".into(),
                    },
                )]
                .into_iter()
    ...
    fn reconstructs_collab_resume_end_item() {
        let events = vec![
            ...
            EventMsg::CollabResumeEnd(atlas_engine_protocol::protocol::CollabResumeEndEvent {
    ...
    fn reconstructs_interrupted_send_input_as_completed_collab_call() {
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentInteractionBegin(
                atlas_engine_protocol::protocol::CollabAgentInteractionBeginEvent {
                    call_id: "send-1".into(),
                    started_at_ms: 0,
            ...
            EventMsg::CollabAgentInteractionEnd(
                atlas_engine_protocol::protocol::CollabAgentInteractionEndEvent {
                    call_id: "send-1".into(),
                    completed_at_ms: 0,
                    sender_thread_id: sender,
                    receiver_thread_id: receiver,
    ...
    fn rollback_failed_error_does_not_mark_turn_failed() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                atlas_engine_error_info: Some(AtlasEngineErrorInfo::ThreadRollbackFailed),
            }),
        ];
    ...
    fn out_of_turn_error_does_not_create_or_fail_a_turn() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                atlas_engine_error_info: Some(AtlasEngineErrorInfo::BadRequest),
            }),
        ];
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                atlas_engine_error_info: Some(AtlasEngineErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                message: "stream failure".into(),
                atlas_engine_error_info: Some(
                    crate::protocol::v2::AtlasEngineErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
    ...
    fn canonical_hook_prompt_completion_updates_turn_history() {
        let hook_prompt = CoreTurnItem::HookPrompt(atlas_engine_protocol::items::HookPromptItem {
