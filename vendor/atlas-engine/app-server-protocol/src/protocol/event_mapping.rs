    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                atlas_engine_protocol::protocol::AgentStatus::Errored(_)
...
mod tests {
    ...
    use atlas_engine_protocol::protocol::CollabResumeBeginEvent;
    use atlas_engine_protocol::protocol::CollabResumeEndEvent;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: atlas_engine_protocol::protocol::AgentStatus::NotFound,
        };
