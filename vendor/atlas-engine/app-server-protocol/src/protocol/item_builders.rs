...
use atlas_engine_protocol::protocol::GuardianAssessmentAction;
...
use atlas_engine_secrets::redact_secrets;
...
pub fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            ...
            atlas_engine_protocol::protocol::GuardianAssessmentStatus::Approved => {
