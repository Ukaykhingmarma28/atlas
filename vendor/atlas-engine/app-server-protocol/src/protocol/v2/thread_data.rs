...
use super::AtlasEngineErrorInfo;
...
use atlas_engine_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use atlas_engine_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. Atlas Agent-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, atlas-agent exec, atlas-agent app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. Atlas Agent-generated turn IDs are UUIDv7.
    pub id: String,
