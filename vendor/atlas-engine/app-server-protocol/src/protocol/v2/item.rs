...
use atlas_engine_experimental_api_macros::ExperimentalApi;
use atlas_engine_extension_items::ExtensionItem;
pub use atlas_engine_extension_items::image_generation::ImageGenerationFailure;
pub use atlas_engine_extension_items::image_generation::ImageGenerationItem;
pub use atlas_engine_extension_items::sleep::SleepItem;
pub use atlas_engine_extension_items::web_search::WebSearchAction;
pub use atlas_engine_extension_items::web_search::WebSearchItem;
use atlas_engine_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use atlas_engine_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use atlas_engine_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use atlas_engine_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use atlas_engine_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use atlas_engine_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use atlas_engine_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use atlas_engine_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: atlas_engine_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        atlas_engine_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        atlas_engine_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        atlas_engine_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        atlas_engine_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<atlas_engine_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: atlas_engine_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for atlas_engine_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
