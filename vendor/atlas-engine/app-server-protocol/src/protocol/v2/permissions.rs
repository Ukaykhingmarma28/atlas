...
use crate::TS;
use atlas_engine_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use atlas_engine_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use atlas_engine_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use atlas_engine_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use atlas_engine_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use atlas_engine_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use atlas_engine_protocol::models::LegacyReadWriteRoots;
...
use atlas_engine_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> atlas_engine_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<atlas_engine_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: atlas_engine_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            atlas_engine_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            atlas_engine_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            atlas_engine_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
