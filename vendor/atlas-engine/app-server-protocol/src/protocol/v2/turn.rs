...
use atlas_engine_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use atlas_engine_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use atlas_engine_protocol::user_input::ByteRange as CoreByteRange;
use atlas_engine_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich Atlas Agent's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-atlas-engine-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
