...
use crate::TS;
use atlas_engine_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use atlas_engine_protocol::protocol::SkillInterface as CoreSkillInterface;
use atlas_engine_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use atlas_engine_protocol::protocol::SkillScope as CoreSkillScope;
use atlas_engine_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// Atlas Agent app-server exposes `"AVAILABLE"` in its API; the alias keeps
