...
pub enum ConfigLayerSource {
    /// Default configuration supplied with the installed Atlas Agent package.
    ...
    /// User config layer from $ATLAS_AGENT_HOME/config.toml. This layer is special
    ...
    /// Path to a .atlas-agent/ folder within a project. There could be multiple of
