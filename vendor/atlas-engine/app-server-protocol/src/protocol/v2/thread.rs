...
pub use atlas_engine_protocol::capabilities::CapabilityRootLocation;
pub use atlas_engine_protocol::capabilities::SelectedCapabilityRoot;
...
pub use atlas_engine_protocol::dynamic_tools::DynamicToolFunctionSpec;
pub use atlas_engine_protocol::dynamic_tools::DynamicToolNamespaceSpec;
pub use atlas_engine_protocol::dynamic_tools::DynamicToolNamespaceTool;
pub use atlas_engine_protocol::dynamic_tools::DynamicToolSpec;
use atlas_engine_protocol::models::ResponseItem;
use atlas_engine_protocol::openai_models::ReasoningEffort;
use atlas_engine_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use atlas_engine_protocol::protocol::TokenUsage as CoreTokenUsage;
use atlas_engine_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "atlas_engine_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. Atlas Agent Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR ATLAS_AGENT CLOUD - DO NOT USE.
...
impl From<atlas_engine_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: atlas_engine_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> atlas_engine_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => atlas_engine_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => atlas_engine_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `atlas_engine_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
