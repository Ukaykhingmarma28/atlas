...
use atlas_engine_protocol::items::McpToolCallError as CoreMcpToolCallError;
use atlas_engine_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use atlas_engine_protocol::mcp::McpServerInfo;
use atlas_engine_protocol::mcp::Resource as McpResource;
pub use atlas_engine_protocol::mcp::ResourceContent as McpResourceContent;
use atlas_engine_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use atlas_engine_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from atlas_engine_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from atlas_engine_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> atlas_engine_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => atlas_engine_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => atlas_engine_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => atlas_engine_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Atlas Agent turn when this elicitation was observed, if app-server could correlate one.
    ///
