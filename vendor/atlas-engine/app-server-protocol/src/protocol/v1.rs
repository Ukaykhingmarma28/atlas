...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $ATLAS_AGENT_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [atlas_engine_protocol::protocol::PatchApplyBeginEvent]
    /// and [atlas_engine_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [atlas_engine_protocol::protocol::ExecCommandBeginEvent]
    /// and [atlas_engine_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
