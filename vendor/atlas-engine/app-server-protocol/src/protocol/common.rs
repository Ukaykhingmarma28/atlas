...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by Atlas Agent.
    ApiKey,
    /// ChatGPT OAuth managed by Atlas Agent (tokens persisted and refreshed by Atlas Agent).
    Chatgpt,
    ...
    Headers,
    /// Programmatic Atlas Agent auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic Atlas Agent auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by Atlas Agent.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by Atlas Agent services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a Atlas Agent sandbox.
...
/// Superset of [`atlas_engine_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by Atlas Agent Cloud.
...
mod tests {
    ...
    fn jsonrpc_request_conversion_preserves_serde_enum_decoding() {
        let requests = [
            JSONRPCRequest {
                ...
                trace: Some(atlas_engine_protocol::protocol::W3cTraceContext {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "atlas_apps".to_string(),
    ...
    fn serialize_account_login_chatgpt() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                atlas_engine_streamlined_login: false,
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                atlas_engine_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
            json!({
                ...
                "params": {
                    "type": "chatgpt",
                    "appBrand": null,
                    "atlasEngineStreamlinedLogin": true
                }
            }),
            serde_json::to_value(&request)?,
        );
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let atlas_engine_managed_bedrock = v2::Account::AmazonBedrock {
            uses_atlas_engine_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesAtlasEngineManagedCredentials": true,
            }),
            serde_json::to_value(&atlas_engine_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesAtlasEngineManagedCredentials": false,
            }),
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "atlasEngineResponsesAsItems": null,
                    "atlasEngineResponseItemPrefix": null,
                    "atlasEngineResponseHandoffMode": "bemTags",
    ...
    fn serialize_thread_realtime_start_prompt_default_and_null() -> Result<()> {
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "atlasEngineResponsesAsItems": null,
                    "atlasEngineResponseItemPrefix": null,
                    "atlasEngineResponseHandoffMode": null,
                    "atlasEngineResponseHandoffChannelPrefixes": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let default_prompt_value = json!({
            ...
            "params": {
                ...
                "atlasEngineResponseHandoffPrefix": "",
                "outputModality": "audio",
                "realtimeSessionId": null,
                "transport": null,
                "voice": null
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: atlas_engine_protocol::config_types::CollaborationMode {
