...
const CONNECTOR_DIRECTORY_DISK_CACHE_DIR: &str = "cache/atlas_engine_app_directory";
...
impl ConnectorDirectoryCacheContext {
    pub fn new(atlas_agent_home: PathBuf, cache_key: ConnectorDirectoryCacheKey) -> Self {
        Self {
            atlas_agent_home,
            cache_key,
        }
