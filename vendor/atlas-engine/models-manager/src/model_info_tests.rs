...
use atlas_engine_protocol::openai_models::ApprovalMessages;
use atlas_engine_protocol::openai_models::AutoReviewMessages;
use atlas_engine_protocol::openai_models::CollaborationModeMessages;
...
fn disabled_personality_uses_plain_base_instructions_for_local_personality_models() {
    ...
    for slug in ["gpt-5.2-codex", "exp-atlas-engine-personality"] {
