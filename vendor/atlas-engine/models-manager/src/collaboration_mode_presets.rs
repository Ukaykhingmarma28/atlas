...
use atlas_engine_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use atlas_engine_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use atlas_engine_protocol::config_types::CollaborationModeMask;
use atlas_engine_protocol::config_types::ModeKind;
use atlas_engine_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
