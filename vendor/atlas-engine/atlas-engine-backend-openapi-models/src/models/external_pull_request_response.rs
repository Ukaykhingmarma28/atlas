...
pub struct ExternalPullRequestResponse {
    ...
    #[serde(rename = "atlas_engine_updated_sha", skip_serializing_if = "Option::is_none")]
    pub atlas_engine_updated_sha: Option<String>,
}
