...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-atlas-engine-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-atlas-engine-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-atlas-engine-server-id", &enrollment.server_id)?;
    ...
    set_remote_control_header(
        headers,
        "x-atlas-engine-protocol-version",
