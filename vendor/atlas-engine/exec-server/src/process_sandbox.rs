...
use atlas_engine_network_proxy::NetworkPolicyDecider;
use atlas_engine_network_proxy::NetworkProxy;
use atlas_engine_network_proxy::NetworkProxyHandle;
use atlas_engine_network_proxy::NetworkProxyState;
use atlas_engine_network_proxy::RemoteNetworkProxyLaunchConfig;
use atlas_engine_network_proxy::is_managed_mitm_ca_trust_bundle_path;
#[cfg(target_os = "windows")]
use atlas_engine_network_proxy::strip_managed_proxy_env;
use atlas_engine_protocol::models::PermissionProfile;
use atlas_engine_sandboxing::SandboxCommand;
use atlas_engine_sandboxing::SandboxDirectSpawnTransformRequest;
...
use atlas_engine_sandboxing::WindowsSandboxProxySettingsMode;
use atlas_engine_sandboxing::WindowsSandboxSpawnRequest;
...
use atlas_engine_sandboxing::with_managed_mitm_ca_readable_root;
use atlas_engine_utils_absolute_path::AbsolutePathBuf;
use atlas_engine_utils_path_uri::PathUri;

#[cfg(unix)]
use crate::ATLAS_AGENT_ARG0_EXEC_HELPER_ARG1;
...
pub(crate) async fn prepare_exec_request(
    ...
    let sandbox_helper_paths = params
        .arg0
        .iter()
        .map(|_| runtime_paths.atlas_engine_self_exe.clone())
        .collect::<Vec<_>>();
    ...
    let sandbox_helper_paths = {
        ...
        if !sandbox_helper_paths.contains(&runtime_paths.atlas_engine_self_exe) {
            sandbox_helper_paths.push(runtime_paths.atlas_engine_self_exe.clone());
        }
        sandbox_helper_paths.extend(runtime_paths.atlas_engine_linux_sandbox_exe.iter().cloned());
    ...
    let (program, args) = params.arg0.as_ref().map_or_else(
        ...
        |arg0| {
            ...
            helper_args.push(ATLAS_AGENT_ARG0_EXEC_HELPER_ARG1.to_string());
    ...
    let transform_request = SandboxDirectSpawnTransformRequest {
        ...
        transform: SandboxTransformRequest {
            ...
            network: None,
            sandbox_policy_cwd,
            atlas_engine_linux_sandbox_exe: runtime_paths.atlas_engine_linux_sandbox_exe.as_deref(),
