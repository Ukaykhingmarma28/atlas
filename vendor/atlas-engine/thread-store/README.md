...
`atlas-engine-thread-store` is the storage boundary for Atlas Agent threads. It defines the
...
- `LocalThreadStore` persists history through `atlas-engine-rollout` JSONL files and
