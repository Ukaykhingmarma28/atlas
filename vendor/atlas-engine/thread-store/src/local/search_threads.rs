...
use atlas_engine_rollout::first_rollout_content_match_snippet;
use atlas_engine_rollout::parse_cursor;
use atlas_engine_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: atlas_engine_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = atlas_engine_rollout::plain_rollout_path(item.path.as_path());
...
) -> Option<atlas_engine_rollout::Cursor> {
