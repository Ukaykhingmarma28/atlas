...
use atlas_engine_rollout::ModelContextScan;
use atlas_engine_rollout::ModelContextScanProgress;
use atlas_engine_rollout::ReverseJsonlScanner;
use atlas_engine_rollout::RolloutItem;
use atlas_engine_rollout::RolloutLine;
use atlas_engine_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = atlas_engine_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
