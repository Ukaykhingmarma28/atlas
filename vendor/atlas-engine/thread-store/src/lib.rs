...
//!
//! Application code should treat [`atlas_engine_protocol::ThreadId`] as the only durable thread handle.
...
pub use atlas_engine_state::MAX_QUEUE_ITEMS;
pub use atlas_engine_state::QueuedUserSubmissionRecord;
