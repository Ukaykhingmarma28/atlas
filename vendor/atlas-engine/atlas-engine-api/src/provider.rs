...
use atlas_engine_client::RequestCompression;
use atlas_engine_client::RetryOn;
use atlas_engine_client::RetryPolicy;
use http::Method;
...
///
/// This is converted into a `RetryPolicy` used by `atlas-engine-client` to drive
