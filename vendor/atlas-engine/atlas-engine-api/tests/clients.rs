...
use atlas_engine_api::ResponsesClient;
use atlas_engine_api::ResponsesOptions;
use atlas_engine_client::HttpTransport;
use atlas_engine_client::Request;
use atlas_engine_client::RequestBody;
use atlas_engine_client::Response;
...
fn provider(name: &str) -> Provider {
    Provider {
        ...
        query_params: None,
        headers: HeaderMap::new(),
        retry: atlas_engine_api::RetryConfig {
            max_attempts: 1,
...
async fn streaming_client_retries_on_transport_error() -> Result<()> {
    ...
    assert_eq!(requests[0].2, atlas_engine_client::RequestCompression::None);
    Ok(())
}
