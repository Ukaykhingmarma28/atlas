...
//! Trace bundle format, writer, and reducer for Atlas Agent rollouts.
//!
//! This crate owns the trace schema. Hot-path Atlas Agent code should depend on the
...
/// Shared recorder context for inference attempts within one Atlas Agent turn.
...
pub use thread::ATLAS_AGENT_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Atlas Agent tool boundary.
...
/// Append-only writer used by hot-path Atlas Agent instrumentation.
