...
/// One Atlas Agent thread/session participating in the rollout.
///
...
/// Provenance for a traced Atlas Agent thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Atlas Agent runtime for one thread.
///
/// A Atlas Agent turn groups protocol/runtime work for one thread activation.
/// It is not a user/assistant message pair; conversation belongs in
/// `ConversationItem`.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AtlasEngineTurn {
