...
/// Runtime operation requested by the model, a JS code cell, or Atlas Agent itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_atlas_engine_turn_id: Option<AtlasEngineTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Atlas Agent tool boundary.
    ///
    ...
    /// they describe how Atlas Agent executed the request, not what the caller sent.
