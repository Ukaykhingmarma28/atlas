...
/// Atlas Agent conversation/session UUID.
...
pub type AtlasEngineTurnId = String;
...
/// Process/session ID returned by Atlas Agent's terminal runtime.
...
/// Canonical reduced graph for one Atlas Agent rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Atlas Agent rollout/session being observed. `trace_id`
    ...
    pub atlas_engine_turns: BTreeMap<AtlasEngineTurnId, AtlasEngineTurn>,
...
impl RolloutTrace {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            atlas_engine_turns: BTreeMap::new(),
