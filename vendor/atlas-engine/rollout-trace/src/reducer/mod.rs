        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                let thread_id = self.code_cell_event_thread_id(
                    event.thread_id,
                    event.atlas_engine_turn_id.as_deref(),
                    &runtime_cell_id,
                    "code cell start",
                )?;
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    atlas_engine_turn_id: event.atlas_engine_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(atlas_engine_turn_id) = event.atlas_engine_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a atlas-agent turn id"
                    );
                };
