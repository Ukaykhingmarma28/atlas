...
use anyhow::Result;
use anyhow::bail;
use atlas_engine_protocol::protocol::CollabAgentInteractionBeginEvent;
use atlas_engine_protocol::protocol::CollabAgentInteractionEndEvent;
use atlas_engine_protocol::protocol::CollabAgentSpawnEndEvent;
use atlas_engine_protocol::protocol::CollabCloseBeginEvent;
use atlas_engine_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_atlas_engine_turn_id: String,
...
impl TraceReducer {
    ...
    pub(in crate::reducer) fn queue_agent_result_interaction_edge(
        ...
        let source = if let Some(source_item_id) = self.latest_assistant_message_item_for_turn(
            ...
            &observed.child_atlas_engine_turn_id,
        ) {
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.atlas_engine_turn_id.as_deref() == Some(atlas_engine_turn_id)
