...
pub struct RawTraceEvent {
    ...
    pub atlas_engine_turn_id: Option<AtlasEngineTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    AtlasEngineTurnStarted {
        atlas_engine_turn_id: AtlasEngineTurnId,
        thread_id: AgentThreadId,
    },
    AtlasEngineTurnEnded {
        atlas_engine_turn_id: AtlasEngineTurnId,
    ...
    InferenceCancelled {
        ...
        /// before Atlas Agent stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why Atlas Agent stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how Atlas Agent began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how Atlas Agent finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_atlas_engine_turn_id: AtlasEngineTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::AtlasEngineTurnEnded { .. }
