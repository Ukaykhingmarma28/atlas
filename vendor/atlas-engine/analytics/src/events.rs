...
use atlas_engine_protocol::protocol::GuardianAssessmentOutcome;
use atlas_engine_protocol::protocol::GuardianCommandSource;
use atlas_engine_protocol::protocol::GuardianRiskLevel;
use atlas_engine_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(AtlasEngineAppMentionedEventRequest),
    AppUsed(AtlasEngineAppUsedEventRequest),
    HookRun(AtlasEngineHookRunEventRequest),
    Compaction(Box<AtlasEngineCompactionEventRequest>),
    Goal(Box<AtlasEngineGoalEventRequest>),
    TurnEvent(Box<AtlasEngineTurnEventRequest>),
    TurnSteer(AtlasEngineTurnSteerEventRequest),
    ArtifactOperation(AtlasEngineArtifactOperationEventRequest),
    CommandExecution(AtlasEngineCommandExecutionEventRequest),
    PluginMeasurement(AtlasEnginePluginMeasurementEventRequest),
    FileChange(AtlasEngineFileChangeEventRequest),
    McpToolCall(AtlasEngineMcpToolCallEventRequest),
    DynamicToolCall(AtlasEngineDynamicToolCallEventRequest),
    CollabAgentToolCall(AtlasEngineCollabAgentToolCallEventRequest),
    WebSearch(AtlasEngineWebSearchEventRequest),
    ImageGeneration(AtlasEngineImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<AtlasEngineAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(AtlasEngineReviewEventRequest),
    PluginUsed(AtlasEnginePluginUsedEventRequest),
    PluginInstallRequested(AtlasEnginePluginInstallRequestedEventRequest),
    PluginInstalled(AtlasEnginePluginEventRequest),
    PluginUninstalled(AtlasEnginePluginEventRequest),
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineArtifactOperationEventParams {
    ...
    pub(crate) runtime: AtlasEngineRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineArtifactOperationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineArtifactOperationEventParams,
}

pub(crate) fn atlas_engine_artifact_operation_event_request(
    tracking: TrackEventsContext,
    operation: ArtifactOperation,
) -> AtlasEngineArtifactOperationEventRequest {
    AtlasEngineArtifactOperationEventRequest {
        event_type: "atlas_engine_artifact_operation",
        event_params: AtlasEngineArtifactOperationEventParams {
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineAcceptedLineFingerprintsEventParams {
    pub(crate) event_type: &'static str,
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct AtlasEngineAppServerClientMetadata {
    pub(crate) product_client_id: String,
...
#[derive(Clone, Serialize)]
pub(crate) struct AtlasEngineRuntimeMetadata {
    pub(crate) atlas_engine_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: AtlasEngineAppServerClientMetadata,
    pub(crate) runtime: AtlasEngineRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Atlas Agent turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginMeasurementEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) item_id: String,
    pub(crate) plugin_id: String,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginMeasurementEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEnginePluginMeasurementEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: AtlasEngineToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: AtlasEngineAppServerClientMetadata,
    ...
    pub(crate) atlas_engine_error_kind: Option<AtlasEngineErrKind>,
    pub(crate) atlas_engine_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: AtlasEngineAppServerClientMetadata,
    ...
    pub(crate) goal_status: atlas_engine_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<AtlasEngineErrorInfo>,
    pub(crate) atlas_engine_error_kind: Option<AtlasEngineErrKind>,
    pub(crate) atlas_engine_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginMetadata {
    pub(crate) plugin_id: Option<String>,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AtlasEnginePluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginInstallRequestedPluginMetadata {
    pub(crate) plugin_id: String,
    pub(crate) remote_plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<AtlasEnginePluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEnginePluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEnginePluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AtlasEnginePluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEnginePluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEngineOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct AtlasEngineOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEngineOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct AtlasEnginePluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AtlasEnginePluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "atlas_engine_plugin_installed",
        PluginState::Uninstalled => "atlas_engine_plugin_uninstalled",
        PluginState::Enabled => "atlas_engine_plugin_enabled",
        PluginState::Disabled => "atlas_engine_plugin_disabled",
    }
}

pub(crate) fn atlas_engine_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> AtlasEngineAppMetadata {
    AtlasEngineAppMetadata {
...
fn atlas_engine_plugin_metadata_with_product_client_id(
...
pub(crate) fn atlas_engine_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> AtlasEnginePluginInstallRequestedMetadata {
    AtlasEnginePluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| AtlasEnginePluginInstallRequestedPluginMetadata {
...
pub(crate) fn atlas_engine_compaction_event_params(
...
) -> AtlasEngineCompactionEventParams {
    AtlasEngineCompactionEventParams {
        ...
        status: input.status,
        atlas_engine_error_kind: input.atlas_engine_error_kind,
        atlas_engine_error_http_status_code: input.atlas_engine_error_http_status_code,
...
pub(crate) fn atlas_engine_goal_event_params(
    input: AtlasEngineGoalEvent,
    session_id: String,
    app_server_client: AtlasEngineAppServerClientMetadata,
    runtime: AtlasEngineRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn atlas_engine_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> AtlasEnginePluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    AtlasEnginePluginUsedMetadata {
        plugin: atlas_engine_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn atlas_engine_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> AtlasEngineHookRunMetadata {
    AtlasEngineHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> AtlasEngineRuntimeMetadata {
    let os_info = os_info::get();
    AtlasEngineRuntimeMetadata {
        atlas_engine_rs_version: env!("CARGO_PKG_VERSION").to_string(),
