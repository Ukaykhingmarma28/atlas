...
pub use atlas_engine_protocol::error::AtlasEngineErrKind;
...
/// Measurements for one successfully decoded image at the point where Atlas Agent prepares it for
...
#[derive(Clone)]
pub struct TurnAtlasEngineErrorFact {
    pub(crate) turn_id: String,
    pub(crate) thread_id: String,
    pub(crate) error: TurnAtlasEngineError,
}
...
impl TurnAtlasEngineErrorFact {
    pub fn from_atlas_engine_err(thread_id: String, turn_id: String, error: &AtlasEngineErr) -> Self {
        Self {
            turn_id,
            thread_id,
            error: TurnAtlasEngineError::from_atlas_engine_err(error),
        }
    }
}

#[derive(Clone)]
pub(crate) struct TurnAtlasEngineError {
    pub(crate) kind: AtlasEngineErrKind,
    pub(crate) http_status_code: Option<u16>,
}

impl TurnAtlasEngineError {
    fn from_atlas_engine_err(error: &AtlasEngineErr) -> Self {
        Self {
            kind: error.into(),
...
#[derive(Clone)]
pub struct AtlasEngineTurnSteerEvent {
...
#[derive(Clone)]
pub struct AtlasEngineCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
    ...
    pub atlas_engine_error_kind: Option<AtlasEngineErrKind>,
    pub atlas_engine_error_http_status_code: Option<u16>,
...
#[derive(Clone)]
pub struct AtlasEngineGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: atlas_engine_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<AtlasEngineCompactionEvent>),
    Goal(Box<AtlasEngineGoalEvent>),
    GuardianReview(Box<GuardianReviewEventParams>),
    TurnResolvedConfig(Box<TurnResolvedConfigFact>),
    TurnTokenUsage(Box<TurnTokenUsageFact>),
    TurnProfile(Box<TurnProfileFact>),
    TurnAtlasEngineError(Box<TurnAtlasEngineErrorFact>),
