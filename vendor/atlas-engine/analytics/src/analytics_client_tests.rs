...
use crate::events::AtlasEngineAcceptedLineFingerprintsEventParams;
use crate::events::AtlasEngineAcceptedLineFingerprintsEventRequest;
use crate::events::AtlasEngineAppMentionedEventRequest;
use crate::events::AtlasEngineAppServerClientMetadata;
use crate::events::AtlasEngineAppUsedEventRequest;
use crate::events::AtlasEngineCommandExecutionEventParams;
use crate::events::AtlasEngineCommandExecutionEventRequest;
use crate::events::AtlasEngineCompactionEventRequest;
use crate::events::AtlasEngineHookRunEventRequest;
use crate::events::AtlasEngineOnboardingExternalAgentImportFailureEventRequest;
use crate::events::AtlasEngineOnboardingExternalAgentImportFailureMetadata;
use crate::events::AtlasEnginePluginEventRequest;
use crate::events::AtlasEnginePluginInstallFailedEventRequest;
use crate::events::AtlasEnginePluginInstallFailedMetadata;
use crate::events::AtlasEnginePluginUsedEventRequest;
use crate::events::AtlasEngineReviewEventParams;
use crate::events::AtlasEngineReviewEventRequest;
use crate::events::AtlasEngineRuntimeMetadata;
use crate::events::AtlasEngineToolItemEventBase;
use crate::events::AtlasEngineTurnEventRequest;
...
use crate::events::atlas_engine_app_metadata;
use crate::events::atlas_engine_hook_run_metadata;
use crate::events::atlas_engine_plugin_metadata;
use crate::events::atlas_engine_plugin_used_metadata;
...
use crate::facts::TurnAtlasEngineErrorFact;
...
use atlas_engine_app_server_protocol::CommandExecutionRequestApprovalParams;
use atlas_engine_app_server_protocol::CommandExecutionRequestApprovalResponse;
use atlas_engine_app_server_protocol::CommandExecutionSource;
use atlas_engine_app_server_protocol::CommandExecutionStatus;
use atlas_engine_app_server_protocol::DynamicToolCallStatus;
use atlas_engine_app_server_protocol::GuardianApprovalReview;
use atlas_engine_app_server_protocol::GuardianApprovalReviewAction;
use atlas_engine_app_server_protocol::GuardianApprovalReviewStatus;
use atlas_engine_app_server_protocol::GuardianCommandSource as AppServerGuardianCommandSource;
use atlas_engine_app_server_protocol::ImageGenerationItem;
...
use atlas_engine_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification;
use atlas_engine_app_server_protocol::ItemStartedNotification;
use atlas_engine_app_server_protocol::JSONRPCErrorError;
use atlas_engine_app_server_protocol::McpToolCallAppContext;
use atlas_engine_app_server_protocol::McpToolCallStatus;
use atlas_engine_app_server_protocol::NonSteerableTurnKind;
use atlas_engine_app_server_protocol::PatchApplyStatus;
use atlas_engine_app_server_protocol::PermissionsRequestApprovalParams;
use atlas_engine_app_server_protocol::RequestId;
use atlas_engine_app_server_protocol::RequestPermissionProfile;
use atlas_engine_app_server_protocol::SandboxPolicy as AppServerSandboxPolicy;
use atlas_engine_app_server_protocol::ServerNotification;
use atlas_engine_app_server_protocol::ServerRequest;
use atlas_engine_app_server_protocol::ServerResponse;
use atlas_engine_app_server_protocol::SessionSource as AppServerSessionSource;
...
use atlas_engine_app_server_protocol::ThreadSource as AppServerThreadSource;
use atlas_engine_app_server_protocol::ThreadStartResponse;
use atlas_engine_app_server_protocol::ThreadStatus as AppServerThreadStatus;
use atlas_engine_app_server_protocol::Turn;
use atlas_engine_app_server_protocol::TurnCompletedNotification;
use atlas_engine_app_server_protocol::TurnDiffUpdatedNotification;
use atlas_engine_app_server_protocol::TurnError as AppServerTurnError;
...
use atlas_engine_app_server_protocol::TurnStatus as AppServerTurnStatus;
...
use atlas_engine_app_server_protocol::WebSearchItem;
use atlas_engine_login::default_client::DEFAULT_ORIGINATOR;
...
use atlas_engine_protocol::approvals::NetworkApprovalProtocol;
...
use atlas_engine_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use atlas_engine_protocol::models::PermissionProfile as CorePermissionProfile;
...
use atlas_engine_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use atlas_engine_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use atlas_engine_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
...
const TEST_PRODUCT_CLIENT_ID: &str = "atlas_engine_work_desktop";
...
fn sample_app_server_client_metadata() -> AtlasEngineAppServerClientMetadata {
    AtlasEngineAppServerClientMetadata {
...
fn sample_runtime_metadata() -> AtlasEngineRuntimeMetadata {
    AtlasEngineRuntimeMetadata {
        atlas_engine_rs_version: "0.1.0".to_string(),
...
fn sample_turn_start_response(turn_id: &str) -> ClientResponsePayload {
    ClientResponsePayload::TurnStart(atlas_engine_app_server_protocol::TurnStartResponse {
        turn: Turn {
...
fn sample_turn_completed_notification(
    ...
    atlas_engine_error_info: Option<atlas_engine_app_server_protocol::AtlasEngineErrorInfo>,
) -> ServerNotification {
    ServerNotification::TurnCompleted(TurnCompletedNotification {
        ...
        turn: Turn {
            ...
            items: vec![],
            status,
            error: atlas_engine_error_info.map(|atlas_engine_error_info| AppServerTurnError {
            ...
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "atlas-engine-web".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "atlas-engine-web".to_string(),
    ...
    reducer
        .ingest(
            AnalyticsFact::Initialize {
                ...
                params: InitializeParams {
                    client_info: ClientInfo {
                        name: "atlas-engine-tui".to_string(),
                        title: None,
                        version: "1.0.0".to_string(),
                    },
                    capabilities: None,
                },
                product_client_id: "atlas-engine-tui".to_string(),
                runtime: sample_runtime_metadata(),
                rpc_transport: AppServerRpcTransport::Stdio,
            },
            out,
...
fn sample_initialize_fact(connection_id: u64) -> AnalyticsFact {
    AnalyticsFact::Initialize {
        ...
        product_client_id: DEFAULT_ORIGINATOR.to_string(),
        runtime: AtlasEngineRuntimeMetadata {
            atlas_engine_rs_version: "0.99.0".to_string(),
...
fn sample_guardian_review_completed(
    ...
    ServerNotification::ItemGuardianApprovalReviewCompleted(
        ItemGuardianApprovalReviewCompletedNotification {
            ...
            decision_source: atlas_engine_app_server_protocol::AutoReviewDecisionSource::Agent,
...
fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
    ...
    let skill_path = PathBuf::from("/repo/root/.atlas-agent/skills/doc/SKILL.md");
    ...
    assert_eq!(path, ".atlas-agent/skills/doc/SKILL.md");
}

#[test]
fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/Users/abc/.atlas-agent/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
    let skill_path = PathBuf::from("/etc/atlas-agent/skills/doc/SKILL.md");
...
fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
    let repo_root = PathBuf::from("/repo/root");
    let skill_path = PathBuf::from("/other/path/.atlas-agent/skills/doc/SKILL.md");
...
fn app_mentioned_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppMentioned(AtlasEngineAppMentionedEventRequest {
        event_type: "atlas_engine_app_mentioned",
        event_params: atlas_engine_app_metadata(
            &tracking,
            AppInvocation {
...
fn app_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::AppUsed(AtlasEngineAppUsedEventRequest {
        event_type: "atlas_engine_app_used",
        event_params: atlas_engine_app_metadata(
            &tracking,
            AppInvocation {
...
fn accepted_line_fingerprints_event_serializes_expected_shape() {
    let event = TrackEventRequest::AcceptedLineFingerprints(Box::new(
        AtlasEngineAcceptedLineFingerprintsEventRequest {
            event_type: "atlas_engine_accepted_line_fingerprints",
            event_params: AtlasEngineAcceptedLineFingerprintsEventParams {
                event_type: "atlas_agent.accepted_line_fingerprints",
                turn_id: "turn-1".to_string(),
                thread_id: "thread-1".to_string(),
                product_surface: Some("atlas-agent".to_string()),
...
// `analytics_flush_delivers_completed_turn_with_file_diff` was here. It
// exercised the debug-only capture-file *delivery* sink through
// `AnalyticsEventsClient::new_for_capture_file`; both the sink and that
// constructor were removed with the upload (#43, spec D2). The reduction it
// leaned on is still covered by the turn-completion tests around it.

#[test]
fn compaction_event_serializes_expected_shape() {
    let event = TrackEventRequest::Compaction(Box::new(AtlasEngineCompactionEventRequest {
        event_type: "atlas_engine_compaction_event",
        event_params: crate::events::atlas_engine_compaction_event_params(
            AtlasEngineCompactionEvent {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
                ...
                atlas_engine_error_kind: None,
                atlas_engine_error_http_status_code: None,
        ...
        json!({
            ...
            "event_params": {
                ...
                "app_server_client": {
                    ...
                    "client_name": "atlas-engine-tui",
                    "client_version": "1.0.0",
                    "rpc_transport": "stdio",
                    "experimental_api_enabled": true
                },
                "runtime": {
                    "atlas_engine_rs_version": "0.1.0",
                    "runtime_os": "macos",
                ...
                "strategy": "memento",
                "status": "completed",
                "atlas_engine_error_kind": null,
                "atlas_engine_error_http_status_code": null,
...
fn thread_initialized_event_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(ThreadInitializedEvent {
        event_type: "atlas_engine_thread_initialized",
        event_params: ThreadInitializedEventParams {
            thread_id: "thread-0".to_string(),
            session_id: "session-thread-0".to_string(),
            app_server_client: AtlasEngineAppServerClientMetadata {
                product_client_id: DEFAULT_ORIGINATOR.to_string(),
                client_name: Some("atlas-engine-tui".to_string()),
                client_version: Some("1.0.0".to_string()),
                rpc_transport: AppServerRpcTransport::Stdio,
...
fn command_execution_event_serializes_expected_shape() {
    let event = TrackEventRequest::CommandExecution(AtlasEngineCommandExecutionEventRequest {
        event_type: "atlas_engine_command_execution_event",
        event_params: AtlasEngineCommandExecutionEventParams {
            base: AtlasEngineToolItemEventBase {
                thread_id: "thread-1".to_string(),
                ...
                app_server_client: AtlasEngineAppServerClientMetadata {
                    product_client_id: "atlas_engine_tui".to_string(),
                    client_name: Some("atlas-engine-tui".to_string()),
    ...
    assert_eq!(
        ...
        json!({
            ...
            "event_params": {
                ...
                "app_server_client": {
                    "product_client_id": "atlas_engine_tui",
                    "client_name": "atlas-engine-tui",
                ...
                "runtime": {
                    "atlas_engine_rs_version": "0.99.0",
                    "runtime_os": "macos",
                    "runtime_os_version": "15.3.1",
                    "runtime_arch": "aarch64"
                },
...
fn review_event_serializes_expected_shape() {
    let event = TrackEventRequest::ReviewEvent(AtlasEngineReviewEventRequest {
...
async fn initialize_caches_client_and_thread_lifecycle_publishes_once_initialized() {
    ...
    assert_eq!(payload[0]["event_type"], "atlas_engine_thread_initialized");
    ...
    assert_eq!(
        payload[0]["event_params"]["runtime"]["atlas_engine_rs_version"],
        "0.99.0"
    );
...
async fn thread_originator_overrides_shared_connection_across_thread_events() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            json!({
                "event_type": "atlas_engine_turn_event",
                "product_client_id": TEST_PRODUCT_CLIENT_ID,
            }),
            json!({
                "event_type": "atlas_engine_compaction_event",
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        atlas_engine_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::Compaction(Box::new(
                AtlasEngineCompactionEvent {
                    ...
                    atlas_engine_error_kind: Some(AtlasEngineErrKind::ContextWindowExceeded),
                    atlas_engine_error_http_status_code: None,
                    active_context_tokens_before: 131_000,
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "atlas_engine_compaction_event");
    assert_eq!(payload[0]["event_params"]["session_id"], "session-thread-1");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["turn_id"], "turn-compact");
    assert_eq!(
        payload[0]["event_params"]["atlas_engine_error_kind"],
        json!("context_window_exceeded")
    );
    assert_eq!(
        payload[0]["event_params"]["atlas_engine_error_http_status_code"],
        json!(null)
    );
    assert_eq!(
        payload[0]["event_params"]["app_server_client"]["product_client_id"],
...
async fn guardian_review_event_ingests_custom_fact_with_optional_target_item() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "atlas_engine_guardian_review");
    assert_eq!(
...
async fn plugin_measurement_batch_emits_directly_and_filters_invalid_rows() {
    ...
    assert_eq!(
        ...
        json!([
            {
                "event_type": "atlas_engine_plugin_measurement_event",
                "event_params": {
                    "thread_id": "thread-1",
                    "turn_id": "turn-1",
                    "item_id": "item-1",
...
async fn command_execution_approval_response_publishes_user_review_event() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "atlas_engine_review_event");
    assert_eq!(payload[0]["event_params"]["thread_id"], "thread-1");
    assert_eq!(payload[0]["event_params"]["turn_id"], "turn-1");
    assert_eq!(payload[0]["event_params"]["item_id"], "item-1");
...
async fn guardian_completed_notification_publishes_review_event_with_thread_metadata() {
    ...
    assert_eq!(payload["event_type"], "atlas_engine_review_event");
...
fn subagent_thread_started_review_serializes_expected_shape() {
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            ...
            forked_from_thread_id: None,
            product_client_id: "atlas-engine-tui".to_string(),
            client_name: "atlas-engine-tui".to_string(),
...
fn subagent_thread_started_thread_spawn_serializes_thread_lineage() {
    let parent_thread_id =
        atlas_engine_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
            .expect("valid thread id");
    let forked_from_thread_id =
        atlas_engine_protocol::ThreadId::from_string("22222222-2222-4222-8222-222222222222")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        atlas_engine_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn subagent_events_keep_thread_originator_with_explicit_turn_connection() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        atlas_engine_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
    ...
    assert_eq!(params.runtime.atlas_engine_rs_version, "0.1.0");
...
fn plugin_used_event_serializes_expected_shape() {
    ...
    let event = TrackEventRequest::PluginUsed(AtlasEnginePluginUsedEventRequest {
        event_type: "atlas_engine_plugin_used",
        event_params: atlas_engine_plugin_used_metadata(&tracking, sample_plugin_metadata()),
    });
...
fn plugin_management_event_serializes_expected_shape() {
    let event = TrackEventRequest::PluginInstalled(AtlasEnginePluginEventRequest {
        event_type: "atlas_engine_plugin_installed",
        event_params: atlas_engine_plugin_metadata(sample_plugin_metadata()),
    });
...
fn plugin_management_event_keeps_plugin_id_local_when_remote_id_exists() {
    ...
    let event = TrackEventRequest::PluginInstalled(AtlasEnginePluginEventRequest {
        event_type: "atlas_engine_plugin_installed",
        event_params: atlas_engine_plugin_metadata(plugin),
    });
...
fn hook_run_event_serializes_expected_shape() {
    let tracking = test_tracking_context("thread-3", "turn-3");
    let event = TrackEventRequest::HookRun(AtlasEngineHookRunEventRequest {
        event_type: "atlas_engine_hook_run",
        event_params: atlas_engine_hook_run_metadata(
            &tracking,
            HookRunFact {
...
fn hook_run_metadata_maps_sources_and_statuses() {
    ...
    let system = serde_json::to_value(atlas_engine_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let project = serde_json::to_value(atlas_engine_hook_run_metadata(
        &tracking,
        HookRunFact {
    ...
    let cloud_requirements = serde_json::to_value(atlas_engine_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
    ...
    let unknown = serde_json::to_value(atlas_engine_hook_run_metadata(
        &tracking,
        HookRunFact {
...
fn hook_run_metadata_maps_stopped_status() {
    ...
    let stopped = serde_json::to_value(atlas_engine_hook_run_metadata(
        &tracking,
        HookRunFact {
            event_name: HookEventName::Stop,
            hook_source: HookSource::User,
...
async fn reducer_ingests_artifact_operation_fact() {
    ...
    assert_eq!(
        ...
        json!([{
            "event_type": "atlas_engine_artifact_operation",
            "event_params": {
                "thread_id": "thread-1",
                "turn_id": "turn-1",
                "item_id": "call-1",
            ...
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    location: SkillInvocationLocation::Host {
                        path: skill_path,
                        scope: atlas_engine_protocol::protocol::SkillScope::User,
                    },
                    plugin_id: None,
...
async fn reducer_includes_plugin_ids_for_plugin_skill_invocations() {
    ...
    let tracking = test_tracking_context("thread-1", "turn-1");
    let skill_path =
        PathBuf::from("/Users/abc/.atlas-agent/plugins/cache/test/sample/skills/doc/SKILL.md");
...
async fn reducer_ingests_hook_run_fact() {
    ...
    let payload = serde_json::to_value(&events).expect("serialize events");
    assert_eq!(payload.as_array().expect("events array").len(), 1);
    assert_eq!(payload[0]["event_type"], "atlas_engine_hook_run");
...
async fn reducer_ingests_app_and_plugin_facts() {
    ...
    assert_eq!(payload[0]["event_type"], "atlas_engine_app_mentioned");
    assert_eq!(payload[1]["event_type"], "atlas_engine_app_used");
    assert_eq!(payload[2]["event_type"], "atlas_engine_plugin_used");
    assert_eq!(
...
async fn reducer_ingests_plugin_state_changed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "atlas_engine_plugin_disabled",
            "event_params": {
                "plugin_id": "sample@test",
                "remote_plugin_id": null,
                "plugin_name": "sample",
...
async fn reducer_ingests_plugin_install_requested_fact() {
    ...
    assert_eq!(
        serde_json::to_value(&events).expect("serialize events"),
        json!([{
            "event_type": "atlas_engine_plugin_install_requested",
            "event_params": {
...
async fn reducer_ingests_external_agent_config_import_completed_fact() {
    ...
    assert_eq!(
        payload,
        json!([{
            "event_type": "atlas_engine_onboarding_external_agent_import_complete",
            "event_params": {
                "import_id": "import-1",
                "source": "app_server",
...
fn external_agent_config_import_failure_event_serializes_expected_shape() {
    let event = TrackEventRequest::ExternalAgentConfigImportFailure(
        AtlasEngineOnboardingExternalAgentImportFailureEventRequest {
            event_type: "atlas_engine_onboarding_external_agent_import_failure",
            event_params: AtlasEngineOnboardingExternalAgentImportFailureMetadata {
                import_id: "import-1".to_string(),
                source: "app_server".to_string(),
                provider_id: "test-provider-42".to_string(),
                item_type: "PLUGINS".to_string(),
...
fn turn_event_serializes_expected_shape() {
    let event = TrackEventRequest::TurnEvent(Box::new(AtlasEngineTurnEventRequest {
        event_type: "atlas_engine_turn_event",
        event_params: crate::events::AtlasEngineTurnEventParams {
            thread_id: "thread-2".to_string(),
...
async fn accepted_turn_steer_emits_expected_event() {
    ...
    assert_eq!(
        payload["event_params"]["app_server_client"]["product_client_id"],
        json!("atlas-engine-tui")
    );
    assert_eq!(
        payload["event_params"]["runtime"]["atlas_engine_rs_version"],
        json!("0.1.0")
    );
...
async fn turn_lifecycle_emits_turn_event() {
    ...
    assert_eq!(payload["event_type"], json!("atlas_engine_turn_event"));
    assert_eq!(payload["event_params"]["thread_id"], json!("thread-2"));
    assert_eq!(
        payload["event_params"]["session_id"],
        json!("session-thread-2")
    ...
    assert_eq!(
        ...
        json!({
            "product_client_id": "atlas-engine-tui",
            "client_name": "atlas-engine-tui",
            "client_version": "1.0.0",
            "rpc_transport": "stdio",
...
async fn turn_event_counts_completed_tool_items() {
    ...
    assert_eq!(
        emitted_tool_events,
        vec![
            ("atlas_engine_command_execution_event", "session-thread-2"),
...
async fn turn_lifecycle_emits_failed_turn_event() {
    ...
    reducer
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::TurnAtlasEngineError(Box::new(
    ...
    reducer
        .ingest(
            AnalyticsFact::Notification(Box::new(sample_turn_completed_notification(
                ...
                Some(atlas_engine_app_server_protocol::AtlasEngineErrorInfo::BadRequest),
            ))),
            &mut out,
        )
        .await;
    ...
    assert_eq!(
        payload["event_params"]["atlas_engine_error_http_status_code"],
        json!(null)
    );
}
