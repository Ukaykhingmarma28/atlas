...
use atlas_engine_otel::RuntimeMetricTotals;
use atlas_engine_otel::RuntimeMetricsSummary;
...
fn runtime_metrics_summary_collects_tool_api_and_streaming_metrics() -> Result<()> {
    ...
    manager.record_duration(
        "atlas_agent.turn.ttft.duration_ms",
        Duration::from_millis(95),
        &[],
    );
    manager.record_duration(
        "atlas_agent.turn.ttfm.duration_ms",
