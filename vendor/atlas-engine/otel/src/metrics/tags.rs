...
const KNOWN_ORIGINATOR_TAG_VALUES: &[&str] = &[
    "atlas_engine_desktop",
    "atlas-engine-app-server",
    "atlas_engine_mcp_server",
    "atlas_agent",
    "atlas-engine-tui",
    "atlas_engine_vscode",
    "none",
    ...
    fn session_metric_tags_include_expected_tags_in_order() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                (ORIGINATOR_TAG, "atlas_engine_cli"),
    ...
    fn session_metric_tags_skip_missing_optional_tags() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                (ORIGINATOR_TAG, "atlas_engine_exec"),
                (MODEL_TAG, "gpt-5.1"),
                (APP_VERSION_TAG, "1.2.3"),
            ]
        );
