...
pub const ATLAS_AGENT_SESSION_ID_ENV_VAR: &str = "ATLAS_AGENT_SESSION_ID";
pub const ATLAS_AGENT_THREAD_ID_ENV_VAR: &str = "ATLAS_AGENT_THREAD_ID";
...
///
/// This prevents accidental propagation of Atlas Agent launch context; it is not a
...
mod non_windows_tests {
    ...
    fn core_inherit_preserves_non_windows_core_vars_case_insensitively() {
        ...
        let expected = HashMap::from([
            ...
            ("home".to_string(), "/home/atlas-agent".to_string()),
