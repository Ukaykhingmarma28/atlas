...
//! Shared model metadata types exchanged between Atlas Agent services and clients.
//!
...
/// Metadata describing a Atlas Agent-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Atlas Agent backend `/models` endpoint.
