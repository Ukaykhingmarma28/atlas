...
/// Backward-compatible name for the shared Atlas Agent Apps tools runtime.
pub type AtlasAppsToolsCache = atlas_engine_connectors::ConnectorRuntimeManager<ToolInfo>;
/// Backward-compatible name for the Atlas Agent Apps runtime context key.
pub type AtlasAppsToolsCacheKey = atlas_engine_connectors::ConnectorRuntimeContextKey;
...
pub use mcp::ATLAS_APPS_MCP_SERVER_NAME;
...
pub use auth_elicitation::MCP_TOOL_ATLAS_APPS_META_KEY;
...
pub use mcp::host_owned_atlas_apps_enabled;
...
pub use atlas_apps::declared_openai_file_input_param_names;
