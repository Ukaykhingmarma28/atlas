...
//! preserve the legacy `atlas_engine_login::default_client::create_client_without_request_logging()`
...
//! startup-sync request helpers remain responsible for applying the standard Atlas Agent headers.
...
use atlas_engine_http_client::RequestBuilder;
