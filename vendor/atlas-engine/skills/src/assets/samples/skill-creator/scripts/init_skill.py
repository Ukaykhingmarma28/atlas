...
[TODO: Add the task-specific guidance AtlasEngine needs. Reference supporting files only when they are relevant.]
"""
...
Replace this placeholder with maintained, task-specific details that AtlasEngine
...
the output AtlasEngine produces.
