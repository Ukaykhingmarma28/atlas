...
pub const ATLAS_AGENT_OPEN_APP_URL: &str = "https://chatgpt.com/codex/open-app";
...
pub(crate) fn compose_success_url(
    ...
    if atlas_engine_streamlined_login {
        params.push(("atlas_engine_streamlined_login", "true".to_string()));
    }
    let query = params
        .into_iter()
