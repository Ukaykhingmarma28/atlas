...
use crate::ATLAS_AGENT_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            atlas_engine_api_key_env_present: self.atlas_engine_api_key_env_present,
            atlas_engine_api_key_env_enabled: self.atlas_engine_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    atlas_engine_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        atlas_engine_api_key_env_present: env_var_present(ATLAS_AGENT_API_KEY_ENV_VAR),
        atlas_engine_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*atlas_engine_api_key_env_enabled*/ false);
