...
const SETUP_BIN: &str = "atlas-engine-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "atlas-engine-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so Atlas Agent binaries that link the
