...
/// Installs the persistent Atlas Agent WFP filters for `account`.
///
...
/// Ensures the persistent Atlas Agent WFP provider exists.
...
/// Ensures the persistent Atlas Agent sublayer exists under the Atlas Agent provider.
