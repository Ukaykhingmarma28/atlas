...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        atlas_agent_home: PathBuf::from(r"C:\Users\atlas-agent"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\atlas-agent\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            atlas_agent_home: PathBuf::from(r"C:\Users\atlas-agent\.sandbox"),
            real_atlas_agent_home: PathBuf::from(r"C:\Users\atlas-agent"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace.atlas-agent")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        atlas_agent_home: request.atlas_agent_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |atlas_agent_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
