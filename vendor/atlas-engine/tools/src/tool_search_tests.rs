...
fn default_search_text_uses_model_visible_namespace_metadata_once() {
    ...
    let spec = ToolSpec::Namespace(crate::ResponsesApiNamespace {
        ...
        description: "Manage Atlas Agent automations.".to_string(),
        tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
    ...
    assert_eq!(
        ...
        "atlas_engine_app Manage Atlas Agent automations. automation_update automation update Create or update automations. Automation options. mode Update mode. schedule Schedule settings. timezone IANA timezone."
    );
}
