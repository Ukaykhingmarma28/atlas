...
pub use atlas_engine_backend_openapi_models::models::ConfigBundleResponse;
pub use atlas_engine_backend_openapi_models::models::CreditStatusDetails;
pub use atlas_engine_backend_openapi_models::models::DeliveredConfigToml;
pub use atlas_engine_backend_openapi_models::models::DeliveredManagedLayers;
pub use atlas_engine_backend_openapi_models::models::DeliveredRequirementsToml;
pub use atlas_engine_backend_openapi_models::models::DeliveredTomlFragment;
pub use atlas_engine_backend_openapi_models::models::PaginatedListTaskListItem;
pub use atlas_engine_backend_openapi_models::models::PlanType;
pub use atlas_engine_backend_openapi_models::models::RateLimitReachedKind;
pub use atlas_engine_backend_openapi_models::models::RateLimitStatusDetails;
pub use atlas_engine_backend_openapi_models::models::RateLimitStatusPayload;
pub use atlas_engine_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use atlas_engine_backend_openapi_models::models::SpendControlLimitDetails;
pub use atlas_engine_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct AtlasEngineWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<AtlasEngineWorkspaceMessage>,
}

/// Authenticated Atlas Agent user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct AtlasEngineUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct AtlasEngineWorkspaceMessage {
    pub message_id: String,
    pub message_type: AtlasEngineWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum AtlasEngineWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: AtlasEngineWorkspaceMessagesResponse = serde_json::from_value(serde_json::json!({
            "messages": [
                {
        ...
        assert_eq!(
            response,
            AtlasEngineWorkspaceMessagesResponse {
                messages: vec![
                    AtlasEngineWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: AtlasEngineWorkspaceMessageType::Headline,
                    ...
                    AtlasEngineWorkspaceMessage {
                        ...
                        message_type: AtlasEngineWorkspaceMessageType::Announcement,
                    ...
                    AtlasEngineWorkspaceMessage {
                        ...
                        message_type: AtlasEngineWorkspaceMessageType::Unknown,
