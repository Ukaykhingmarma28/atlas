...
pub(crate) fn completed_summary(
    ...
    entries: Vec<atlas_engine_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: atlas_engine_protocol::protocol::HookSource) -> &'static str {
    match source {
        ...
        atlas_engine_protocol::protocol::HookSource::Project => "project",
        atlas_engine_protocol::protocol::HookSource::Mdm => "mdm",
        atlas_engine_protocol::protocol::HookSource::SessionFlags => "session_flags",
        atlas_engine_protocol::protocol::HookSource::Plugin => "plugin",
        atlas_engine_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        atlas_engine_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
