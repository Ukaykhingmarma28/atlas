...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// Atlas Agent extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_atlas_engine_turn_id_extension() {
        // Atlas Agent intentionally diverges from Claude's public hook docs here so
