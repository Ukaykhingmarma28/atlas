...
/// Basename used when the Atlas Agent executable self-invokes as the Linux sandbox
/// helper.
pub const ATLAS_AGENT_LINUX_SANDBOX_ARG0: &str = "atlas-engine-linux-sandbox";
