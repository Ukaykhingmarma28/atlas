...
pub struct ResponseItemEnvelope {
    ...
    pub metadata: Option<AtlasEngineHarnessMetadata>,
}

/// Metadata owned by the Atlas Agent harness and persisted with a response item.
///
#[derive(Serialize, Deserialize, Debug, Clone, Default, PartialEq, Eq, JsonSchema)]
pub struct AtlasEngineHarnessMetadata {
