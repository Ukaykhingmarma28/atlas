...
use atlas_engine_core_plugins::PluginInstallError;
use atlas_engine_core_plugins::PluginInstallRequest;
use atlas_engine_core_plugins::marketplace::MarketplaceError;
use atlas_engine_core_plugins::marketplace::find_marketplace_manifest_path;
use atlas_engine_core_plugins::marketplace_add::MarketplaceAddRequest;
use atlas_engine_core_plugins::marketplace_add::add_marketplace;
        ...
        let config = ConfigBuilder::default()
            ...
            .fallback_cwd(Some(
                cwd.map(Path::to_path_buf)
                    .unwrap_or_else(|| self.atlas_agent_home.clone()),
            ))
            .build()
            .await
