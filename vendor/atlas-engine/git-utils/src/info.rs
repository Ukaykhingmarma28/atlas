...
use atlas_engine_file_system::find_nearest_native_ancestor_with_markers;
...
/// directory. If you need Atlas Agent to work from such a checkout simply pass the
...
mod tests {
    ...
    async fn git_metadata_commands_do_not_inherit_stdin() {
        const CHILD_ENV: &str = "ATLAS_AGENT_GIT_UTILS_STDIN_CHILD";
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/Atlas Agent.git",
            "ssh://git@github.com/openai/atlas-agent.git",
            "ssh://git@github.com:22/OpenAI/Atlas Agent.git",
            "https://github.com/openai/codex.git",
            "https://github.com:443/openai/codex.git",
            "https://token@github.com/openai/codex/",
            "github.com/OpenAI/Atlas Agent.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/atlas-agent".to_string())
            );
        }
    }
