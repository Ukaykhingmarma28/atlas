...
//!
//! Atlas Agent overrides `core.fsmonitor` so repository configuration cannot select
...
/// layered, may use conditional includes, and can change while Atlas Agent is
/// running:
