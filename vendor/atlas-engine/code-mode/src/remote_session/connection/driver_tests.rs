...
use atlas_engine_code_mode_protocol::CodeModeNestedToolCall;
...
use atlas_engine_code_mode_protocol::NotificationFuture;
use atlas_engine_code_mode_protocol::ToolInvocationFuture;
...
use atlas_engine_code_mode_protocol::host::DelegateRequest;
use atlas_engine_code_mode_protocol::host::DelegateRequestId;
use atlas_engine_code_mode_protocol::host::DelegateResponse;
...
use atlas_engine_code_mode_protocol::host::MAX_PENDING_DELEGATE_CALLS;
use atlas_engine_code_mode_protocol::host::RequestId;
use atlas_engine_code_mode_protocol::host::SessionId;
use atlas_engine_code_mode_protocol::host::WireNestedToolCall;
use atlas_engine_code_mode_protocol::host::WireResult;
use atlas_engine_code_mode_protocol::host::WireRuntimeResponse;
use atlas_engine_code_mode_protocol::host::WireSessionCellExecutionLimits;
use atlas_engine_code_mode_protocol::host::WireWaitOutcome;
...
struct DriverHarness {
    ...
    outgoing_rx: mpsc::Receiver<atlas_engine_code_mode_protocol::host::EncodedFrame>,
...
impl DriverHarness {
    ...
    async fn start_cell(
        ...
        request_id: i64,
        cell_id: &str,
    ) -> atlas_engine_code_mode_protocol::StartedCell {
        let (response_tx, response_rx) = oneshot::channel();
        self.command_tx
...
async fn terminate_closes_cell_without_waiting_for_delegate_cleanup() {
    ...
    assert_eq!(
        ...
        Ok(atlas_engine_code_mode_protocol::WaitOutcome::LiveCell(
            atlas_engine_code_mode_protocol::RuntimeResponse::Terminated {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
...
async fn remote_wait_accepts_durations_longer_than_five_minutes() {
    ...
    assert_eq!(
        ...
        Ok(atlas_engine_code_mode_protocol::WaitOutcome::LiveCell(
            atlas_engine_code_mode_protocol::RuntimeResponse::Yielded {
                cell_id: CellId::new("1".to_string()),
                content_items: Vec::new(),
            }
        ))
